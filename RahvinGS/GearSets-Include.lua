...
----------------------------------------------------------------------------------------------------
-- THE GEAR LIBRARY -- one named entry per item, carrying the number swaps are ordered by
----------------------------------------------------------------------------------------------------
-- CONTENTS
--   The three builders ..... hp_gear, mp_gear, rank_gear, and the shared constructor
...
-- JSE capes. One item per job with a player-chosen augment set, so each job's capes are
-- separate entries for the same item name, keyed by what the augments are for. The trailing
-- annotation on each line records the augments that are not obvious from the key.
--BLU Capes
...
--DNC Capes
gear.dncDA = hp_gear("Senuna's Mantle", 0, {
    augments = { 'DEX+20', 'Accuracy+20 Attack+20', 'Accuracy+10', '"Dbl.Atk."+10', 'Damage taken-5%', }, })       --DA 10, DT 5, Acc 20, Acc 10
gear.dncDW = hp_gear("Senuna's Mantle", 0, {
    augments = { 'DEX+20', 'Accuracy+20 Attack+20', 'DEX+10', '"Dual Wield"+10', 'Damage taken-5%', }, })          --DW 10, DT 5, Acc 20
gear.dncSTP = hp_gear("Senuna's Mantle", 0, {
    augments = { 'DEX+20', 'Accuracy+20 Attack+20', 'Accuracy+10', '"Store TP"+10', 'Damage taken-5%', }, })       --STP 10, DT 5, Acc 20, Acc 10
gear.dncWSD = hp_gear("Senuna's Mantle", 0, {
    augments = { 'DEX+20', 'Accuracy+20 Attack+20', 'DEX+10', 'Weapon skill damage +10%', 'Damage taken-5%', }, }) --WSD 10, DT 5, Acc 20
gear.dncFC = hp_gear("Senuna's Mantle", 80, {
    augments = { 'HP+60', 'HP+20', '"Fast Cast"+10' }, })                                                          --HP 60, HP 20, FC 10
gear.dncIdle = hp_gear("Senuna's Mantle", 60, {
    augments = { 'HP+60', 'Eva.+20 /Mag. Eva.+20', 'Enmity-10', 'Damage taken-5%', }, })                           --Enmity -10, DT 5
...
-- Current-era sets: the armor families, one block per family, each entry priced by its own
-- total HP. The slot-by-slot pieces that belong to no family follow under Non-Set Pieces.

--A Crystalline Prophecy
gear.mirkeWardecors = hp_gear("Mirke Wardecors", 10) --STR/DEX/AGI 5, MP 10
gear.nuevoCoselete = hp_gear("Nuevo Coselete", 20)   --STR/DEX/VIT 5
gear.royalRedingote = mp_gear("Royal Redingote", 20) --INT/MND/CHR 5, MP 20

--A Moogle Kupo d'Etat
gear.anwigSalade = hp_gear("Anwig Salade", 10)        --SB 3, MP 10
gear.championsGalea = hp_gear("Champion's Galea", 15) --Counter 3
gear.selenianCap = mp_gear("Selenian Cap", 20)        --Conserve MP 3, MP 20

--A Shantotto Ascension
gear.blitzerPoleyn = hp_gear("Blitzer Poleyn", 0)          --STR 2, VIT 2
gear.desultorTassets = hp_gear("Desultor Tassets", 0)      --DEX 2, AGI 2
gear.tatsumakiSitagoromo = hp_gear("Tatsu. Sitagoromo", 0) --INT 2, MND 2, CHR 2
...
--Arke (Superior 3; WAR PLD DRG)
gear.arkeHead = hp_gear("Arke Zuchetto", 136)            --DT 8, Haste 7, DT-to-TP 8, Status Res 5
gear.arkeHeadPlusOne = hp_gear("Arke Zuchetto +1", 156)  --DT 9, Haste 7, DT-to-TP 10, Status Res 6
gear.arkeBody = hp_gear("Arke Corazza", 205)             --DT 12, Haste 3, DT-to-TP 12, Status Res 7
gear.arkeBodyPlusOne = hp_gear("Arke Corazza +1", 225)   --DT 13, Haste 3, DT-to-TP 14, Status Res 8
gear.arkeHands = hp_gear("Arke Manopolas", 102)          --DT 6, Haste 4, DT-to-TP 6, Status Res 3
gear.arkeHandsPlusOne = hp_gear("Ar. Manopolas +1", 122) --DT 7, Haste 4, DT-to-TP 8, Status Res 4
gear.arkeLegs = hp_gear("Arke Cosciales", 171)           --DT 10, Haste 5, DT-to-TP 10, Status Res 6
gear.arkeLegsPlusOne = hp_gear("Arke Cosc. +1", 191)     --DT 11, Haste 5, DT-to-TP 12, Status Res 7
gear.arkeFeet = hp_gear("Arke Gambieras", 114)           --DT 4, Haste 3, DT-to-TP 4, Status Res 4
gear.arkeFeetPlusOne = hp_gear("Ar. Gambieras +1", 134)  --DT 5, Haste 3, DT-to-TP 6, Status Res 5
...
--Baayami (Superior 3; SMN)
gear.baayamiHead = hp_gear("Baayami Hat", 34)               --Haste 6, MDB 5, Summoning 26, Avatar: Regain 3
gear.baayamiHeadPlusOne = hp_gear("Baayami Hat +1", 49)     --Haste 6, MDB 6, Summoning magic Skill 31
gear.baayamiBody = hp_gear("Baayami Robe", 68)              --Haste 3, FC 11, MDB 8, SMN SIRD 100, Summoning 32
gear.baayamiBodyPlusOne = hp_gear("Baayami Robe +1", 83)    --FC 12, Haste 3, MDB 9, Summoning magic Skill 37
gear.baayamiHands = hp_gear("Baayami Cuffs", 6)             --Haste 3, MDB 4, Summoning 28, BP Delay -6, Avatar: Regen 5
gear.baayamiHandsPlusOne = hp_gear("Baayami Cuffs +1", 21)  --Haste 3, MDB 5, Summoning magic Skill 33
gear.baayamiLegs = hp_gear("Baayami Slops", 61)             --Haste 5, MDB 7, Summoning magic Skill 30
gear.baayamiLegsPlusOne = hp_gear("Baayami Slops +1", 76)   --Haste 5, MDB 8, Summoning 35, BP Delay -8, Avatar: Regen 7
gear.baayamiFeet = hp_gear("Baayami Sabots", 15)            --Haste 3, Refresh 2, MDB 5, Summoning 24, Avatar: Regen 4
gear.baayamiFeetPlusOne = hp_gear("Baaya. Sabots +1", 30)   --Refresh 3, Haste 3, MDB 6, Summoning magic Skill 29

--Bravery (Limbus, Superior 4; BLM SMN SCH GEO)
gear.braveryHead = hp_gear("Bravery Petasos", 74) --DT 2, Haste 6, FC 4, Enmity -4, MAB 40, MDmg 20, MDB 7, Avatar: Enmity +6
gear.braveryBody = hp_gear("Bravery Coat", 97)    --DT 4, Haste 3, FC 8, Enmity -8, MAB 40, MDmg 20, MDB 8, Avatar: Crit 6
gear.braveryHands = hp_gear("Bravery Gloves", 63) --Haste 3, FC 2, Enmity -2, MAB 40, MDmg 20, MDB 5, Avatar: DA 6
gear.braveryLegs = hp_gear("Bravery Tonban", 86)  --DT 3, Haste 5, FC 6, Enmity -6, MAB 40, MDmg 20, MDB 7, Favor 1
gear.braveryFeet = hp_gear("Bravery Sabots", 52)  --DT 1, Haste 3, FC 2, Enmity -2, MAB 40, MDmg 20, MDB 7, Avatar: Lv +1
...
--Clemency (Limbus, Superior 5; RNG SAM DRG COR)
gear.clemencyHead = hp_gear("Clemen. Somen", 96)  --DT 6, Haste 6, Crit 6, PDL 6, MDB 6, Wyvern: HP 18%
gear.clemencyBody = hp_gear("Clemen. Hara.", 119) --DT 8, Haste 3, Crit 8, PDL 8, MDB 8, Wyvern: DT 8
gear.clemencyHands = hp_gear("Clemency Kote", 84) --DT 4, Haste 3, Crit 4, PDL 4, MDB 5, Wyvern: SB 8
gear.clemencyLegs = hp_gear("Clem. Haidate", 107) --DT 7, Haste 5, Crit 7, PDL 7, MDB 7, Wyvern: Regen 8
gear.clemencyFeet = hp_gear("Clem. Sune-Ate", 73) --DT 5, Haste 3, Crit 5, PDL 5, MDB 6, Wyvern: Lv +1

--Councilor's
gear.councilorCuffs = hp_gear("Councilor's Cuffs", 0) --DEF 1
gear.councilorGarb = hp_gear("Councilor's Garb", 0)   --Adoulin Movement 25%

--Crepuscular (Set: Auto-Reraise)
gear.crepuscularMail = hp_gear("Crepuscular Mail", 159) --Haste 2, STP 10, Refresh 2, MDB 9, Acc 55, Macc 55

--Delegate's
gear.delegateCuffs = hp_gear("Delegate's Cuffs", 0) --DEF 1
gear.delegateGarb = hp_gear("Delegate's Garb", 0)   --Enchantment: Teleport (Adoulin Castle Gates)

--Doyen
gear.doyenLegs = hp_gear("Doyen Pants", 43) --Cure FC 15, Stoneskin FC 10, Song FC 6

--Duty (Limbus, Superior 5; MNK THF BST PUP DNC)
gear.dutyHead = hp_gear("Duty Crown", 119)      --DT 5, Haste 6, DA 5, MDB 5, SB 5, Pet: Crit 8
gear.dutyBody = hp_gear("Duty Cyclas", 141)     --DT 7, Haste 4, DA 7, MDB 9, SB 7, Pet: Dmg Dealt 8
gear.dutyHands = hp_gear("Duty Gauntlets", 107) --DT 3, Haste 4, DA 3, MDB 5, SB 3, Pet: SB 8
gear.dutyLegs = hp_gear("Duty Flanchard", 130)  --DT 6, Haste 6, DA 6, MDB 8, SB 6, Pet: DA 8
gear.dutyFeet = hp_gear("Duty Sollerets", 96)   --DT 4, Haste 3, DA 4, MDB 8, SB 4, Pet: Lv +1

--Ea (Superior 3; BLM RDM GEO)
gear.eaHead = hp_gear("Ea Hat", 34)                      --Haste 6, MAB 33, MDB 5, Magic Burst II 6, Magic Burst 6
gear.eaHeadPlusOne = hp_gear("Ea Hat +1", 54)            --Haste 6, MAB 38, Macc 50, MBD 7, MDB 6
gear.eaBody = hp_gear("Ea Houppelande", 68)              --Haste 3, MAB 39, MDB 8, Magic Burst II 8, Magic Burst 8
gear.eaBodyPlusOne = hp_gear("Ea Houppe. +1", 88)        --Haste 3, MAB 44, Macc 52, MBD 9, MDB 9
gear.eaHands = hp_gear("Ea Cuffs", 6)                    --Haste 3, MAB 30, MDB 4, Magic Burst II 5, Magic Burst 5
gear.eaHandsPlusOne = hp_gear("Ea Cuffs +1", 26)         --Haste 3, MAB 35, MDB 5, Magic Burst II 6, Magic Burst 6
gear.eaLegs = hp_gear("Ea Slops", 61)                    --Haste 5, MAB 36, MDB 7, Magic Burst II 7, Magic Burst 7
gear.eaLegsPlusOne = hp_gear("Ea Slops +1", 81)          --Haste 5, MAB 41, MDB 8, Magic Burst II 8, Magic Burst 8
gear.eaFeet = hp_gear("Ea Pigaches", 15)                 --Haste 3, MAB 27, MDB 5, Magic Burst II 4, Magic Burst 4
gear.eaFeetPlusOne = hp_gear("Ea Pigaches +1", 35)       --Haste 3, MAB 32, MDB 6, Magic Burst II 5, Magic Burst 5
...
--Glory Crown
gear.gloryCrown = hp_gear("Glory Crown", 0) --No stats

--Grace (Limbus, Superior 4; RNG SAM DRG COR)
gear.graceHead = hp_gear("Grace Somen", 91)     --DT 5, Haste 6, Crit 5, PDL 5, MDB 5, Wyvern: HP 17%
gear.graceBody = hp_gear("Grace Haramaki", 114) --DT 7, Haste 3, Crit 7, PDL 7, MDB 7, Wyvern: DT 7
gear.graceHands = hp_gear("Grace Kote", 79)     --DT 3, Haste 3, Crit 3, PDL 3, MDB 4, Wyvern: SB 7
gear.graceLegs = hp_gear("Grace Haidate", 102)  --DT 6, Haste 5, Crit 6, PDL 6, MDB 6, Wyvern: Regen 7
gear.graceFeet = hp_gear("Grace Sune-Ate", 68)  --DT 4, Haste 3, Crit 4, PDL 4, MDB 5, Wyvern: Lv +1

--Heyoka (Superior 3; BST PUP)
gear.heyokaHead = hp_gear("Heyoka Cap", 57)                 --Haste 6, Crit 5, MDB 5, Pet: Haste 6, Enmity +8
gear.heyokaHeadPlusOne = hp_gear("Heyoka Cap +1", 77)       --Haste 6, Crit 7, MDB 6, Pet: Haste 6, Enmity +10
gear.heyokaBody = hp_gear("Heyoka Harness", 91)             --Haste 4, Crit 9, MDB 8, Pet: Haste 4, Enmity +10
gear.heyokaBodyPlusOne = hp_gear("He. Harness +1", 111)     --Haste 4, Crit 11, MDB 9, Pet: Haste 4, Enmity +12
gear.heyokaHands = hp_gear("Heyoka Mittens", 29)            --Haste 4, Crit 5, MDB 4, Pet: Haste 4, Enmity +7
gear.heyokaHandsPlusOne = hp_gear("He. Mittens +1", 49)     --Haste 4, Crit 7, MDB 5, Pet: Haste 4, Enmity +9
gear.heyokaLegs = hp_gear("Heyoka Subligar", 84)            --Haste 9, Crit 7, MDB 7, Pet: Haste 9, Enmity +9
gear.heyokaLegsPlusOne = hp_gear("Heyoka Subligar +1", 104) --Haste 9, Crit 9, MDB 8, Pet: Haste 9, Enmity +11
gear.heyokaFeet = hp_gear("Heyoka Leggings", 38)            --Haste 3, Crit 5, MDB 5, Pet: Haste 3, Enmity +6
gear.heyokaFeetPlusOne = hp_gear("He. Leggings +1", 58)     --Haste 3, Crit 7, MDB 6, Pet: Haste 3, Enmity +8
...
--Hope (Limbus, Superior 4; WAR BRD NIN)
gear.hopeHead = hp_gear("Hope Masque", 97)     --DT 4, Haste 6, STP 4, Crit 4, MDB 5
gear.hopeBody = hp_gear("Hope Platemail", 120) --DT 6, Haste 4, STP 6, Crit 6, MDB 5
gear.hopeHands = hp_gear("Hope Gauntlets", 86) --DT 2, Haste 4, STP 2, Crit 2, MDB 2
gear.hopeLegs = hp_gear("Hope Brais", 109)     --DT 5, Haste 9, STP 5, Crit 5, MDB 4
gear.hopeFeet = hp_gear("Hope Sabatons", 74)   --DT 3, Haste 3, STP 3, Crit 3, MDB 4
...
--Indomitable (Limbus, Superior 5; BLM SMN SCH GEO)
gear.indomitableHead = hp_gear("Indom. Petasos", 84)    --DT 4, Haste 6, FC 6, Enmity -6, MAB 40, MDmg 22, MDB 9, Avatar: Enmity +8
gear.indomitableBody = hp_gear("Indomitable Coat", 107) --DT 6, Haste 3, FC 10, Enmity -10, MAB 40, MDmg 22, MDB 10, Avatar: Crit 8
gear.indomitableHands = hp_gear("Indom. Gloves", 73)    --DT 2, Haste 3, FC 4, Enmity -4, MAB 40, MDmg 22, MDB 7, Avatar: DA 8
gear.indomitableLegs = hp_gear("Indom. Tonban", 96)     --DT 5, Haste 5, FC 8, Enmity -8, MAB 40, MDmg 22, MDB 9, Favor 1
gear.indomitableFeet = hp_gear("Indom. Sabots", 62)     --DT 3, Haste 3, FC 4, Enmity -4, MAB 40, MDmg 22, MDB 9, Avatar: Lv +1

--Intrepid (Limbus, Superior 4; BLM SMN SCH GEO)
gear.intrepidHead = hp_gear("Intrepid Petasos", 79) --DT 3, Haste 6, FC 5, Enmity -5, MAB 40, MDmg 21, MDB 8, Avatar: Enmity +7
gear.intrepidBody = hp_gear("Intrepid Coat", 102)   --DT 5, Haste 3, FC 9, Enmity -9, MAB 40, MDmg 21, MDB 9, Avatar: Crit 7
gear.intrepidHands = hp_gear("Intrepid Gloves", 68) --DT 1, Haste 3, FC 3, Enmity -3, MAB 40, MDmg 21, MDB 6, Avatar: DA 7
gear.intrepidLegs = hp_gear("Intrep. Tonban", 91)   --DT 4, Haste 5, FC 7, Enmity -7, MAB 40, MDmg 21, MDB 8, Favor 1
gear.intrepidFeet = hp_gear("Intrep. Sabots", 57)   --DT 2, Haste 3, FC 3, Enmity -3, MAB 40, MDmg 21, MDB 8, Avatar: Lv +1
...
--Justice (Limbus, Superior 4; MNK THF BST PUP DNC)
gear.justiceHead = hp_gear("Justice Crown", 109)   --DT 3, Haste 6, DA 3, MDB 3, SB 3, Pet: Crit 6
gear.justiceBody = hp_gear("Justice Cyclas", 131)  --DT 5, Haste 4, DA 5, MDB 7, SB 5, Pet: Dmg Dealt 6
gear.justiceHands = hp_gear("Just. Gauntlets", 97) --DT 1, Haste 4, DA 1, MDB 3, SB 1, Pet: SB 6
gear.justiceLegs = hp_gear("Just. Flanchard", 120) --DT 4, Haste 6, DA 4, MDB 6, SB 4, Pet: DA 6
gear.justiceFeet = hp_gear("Just. Soll.", 86)      --DT 2, Haste 3, DA 2, MDB 6, SB 2, Pet: Lv +1
...
--Kendatsuba (Superior 3; MNK SAM NIN)
gear.kendatsubaHead = hp_gear("Ken. Jinpachi", 68)               --Haste 6, Crit 3, TA 3, MDB 5, SB 5
gear.kendatsubaHeadPlusOne = hp_gear("Ken. Jinpachi +1", 88)     --TA 4, Haste 6, MDB 6, Racc 45, Acc 50
gear.kendatsubaBody = hp_gear("Ken. Samue", 102)                 --Haste 4, Crit 7, TA 5, MDB 8, SB 9
gear.kendatsubaBodyPlusOne = hp_gear("Ken. Samue +1", 122)       --TA 6, Haste 4, MDB 9, Racc 47, Acc 52
gear.kendatsubaHands = hp_gear("Ken. Tekko", 41)                 --Haste 4, Crit 3, TA 3, MDB 4, SB 5
gear.kendatsubaHandsPlusOne = hp_gear("Ken. Tekko +1", 61)       --TA 4, Haste 4, MDB 5, Racc 44, Acc 49
gear.kendatsubaLegs = hp_gear("Ken. Hakama", 95)                 --Haste 9, Crit 5, TA 4, MDB 7, SB 7
gear.kendatsubaLegsPlusOne = hp_gear("Ken. Hakama +1", 115)      --TA 5, Haste 9, MDB 8, Racc 46, Acc 51
gear.kendatsubaFeet = hp_gear("Ken. Sune-Ate", 50)               --Haste 3, Crit 3, TA 3, MDB 5, SB 5
gear.kendatsubaFeetPlusOne = hp_gear("Ken. Sune-Ate +1", 70)     --TA 4, SB 8, Crit 5

--Magnificent (Limbus, Superior 4; MNK THF BST PUP DNC)
gear.magnificentHead = hp_gear("Magnif. Crown", 114)   --DT 4, Haste 6, DA 4, MDB 4, SB 4, Pet: Crit 7
gear.magnificentBody = hp_gear("Magnif. Cyclas", 136)  --DT 6, Haste 4, DA 6, MDB 8, SB 6, Pet: Dmg Dealt 7
gear.magnificentHands = hp_gear("Magnif. Gaunt.", 102) --DT 2, Haste 4, DA 2, MDB 4, SB 2, Pet: SB 7
gear.magnificentLegs = hp_gear("Magnif. Flan.", 125)   --DT 5, Haste 6, DA 5, MDB 7, SB 5, Pet: DA 7
gear.magnificentFeet = hp_gear("Magnif. Soll.", 91)    --DT 3, Haste 3, DA 3, MDB 7, SB 3, Pet: Lv +1
...
--Mercy (Limbus, Superior 4; RNG SAM DRG COR)
gear.mercyHead = hp_gear("Mercy Somen", 86)     --DT 4, Haste 6, Crit 4, PDL 4, MDB 4, Wyvern: HP 16%
gear.mercyBody = hp_gear("Mercy Haramaki", 109) --DT 6, Haste 3, Crit 6, PDL 6, MDB 6, Wyvern: DT 6
gear.mercyHands = hp_gear("Mercy Kote", 74)     --DT 2, Haste 3, Crit 2, PDL 2, MDB 3, Wyvern: SB 6
gear.mercyLegs = hp_gear("Mercy Haidate", 97)   --DT 5, Haste 5, Crit 5, PDL 5, MDB 5, Wyvern: Regen 6
gear.mercyFeet = hp_gear("Mercy Sune-Ate", 63)  --DT 3, Haste 3, Crit 3, PDL 3, MDB 4, Wyvern: Lv +1

--Mousai (Superior 3; BRD)
gear.mousaiHead = hp_gear("Mousai Turban", 102)             --Haste 6, MDB 6, Etude 1
gear.mousaiHeadPlusOne = hp_gear("Mousai Turban +1", 122)   --Haste 6, MDB 7
gear.mousaiBody = hp_gear("Mousai Manteel", 171)            --Haste 3, MDB 8, Threnody 1
gear.mousaiBodyPlusOne = hp_gear("Mou. Manteel +1", 191)    --Haste 3, Macc 52, MDB 9
gear.mousaiHands = hp_gear("Mousai Gages", 68)              --Haste 3, MDB 4, Carol 1
gear.mousaiHandsPlusOne = hp_gear("Mousai Gages +1", 88)    --Haste 3, MDB 5
gear.mousaiLegs = hp_gear("Mousai Seraweels", 136)          --Haste 5, MDB 8, Minne 1
gear.mousaiLegsPlusOne = hp_gear("Mou. Seraweels +1", 156)  --Minne 2
gear.mousaiFeet = hp_gear("Mousai Crackows", 79)            --Haste 3, MDB 6, Mambo 1
gear.mousaiFeetPlusOne = hp_gear("Mou. Crackows +1", 99)    --Haste 3, MDB 7, Mambo 2
...
--Oshosi (Superior 3; RNG COR)
gear.oshosiHead = hp_gear("Oshosi Mask", 57)                  --MDB 6, DS Dmg 20, TS Dmg 10, DS 5, TS 4
gear.oshosiHeadPlusOne = hp_gear("Oshosi Mask +1", 77)     --Macc 50, MDB 7, Racc 45
gear.oshosiBody = hp_gear("Oshosi Vest", 91)               --STP 7, MDB 8, Snapshot 12, DS 7, TS 6
gear.oshosiBodyPlusOne = hp_gear("Oshosi Vest +1", 111)    --STP 10, Snapshot 14, Macc 52, MDB 9, Racc 47
gear.oshosiHands = hp_gear("Oshosi Gloves", 29)            --MDB 4, Snapshot 8, SB 10, DS 4, TS 3
gear.oshosiHandsPlusOne = hp_gear("Oshosi Gloves +1", 49)  --Snapshot 10, Macc 49, MDB 5, Racc 44, SB 15
gear.oshosiLegs = hp_gear("Oshosi Trousers", 84)           --Racc 36, Snapshot 10, True Shot 4, DS 6, TS 5
gear.oshosiLegsPlusOne = hp_gear("Osh. Trousers +1", 104)  --Snapshot 12, Macc 51, MDB 9, Racc 46
gear.oshosiFeet = hp_gear("Oshosi Leggings", 38)           --Crit 8, Enmity -10, MDB 6, DS 3, TS 2
gear.oshosiFeetPlusOne = hp_gear("Osh. Leggings +1", 58)   --Macc 48, MDB 7, Racc 43, Enmity -15

--Perfection (Limbus, Superior 4; WAR BRD NIN)
gear.perfectionHead = hp_gear("Perfection Masque", 102) --DT 5, Haste 6, STP 5, Crit 5, MDB 6
gear.perfectionBody = hp_gear("Perfection Plate.", 125) --DT 7, Haste 4, STP 7, Crit 7, MDB 6
gear.perfectionHands = hp_gear("Perfection Gaunt.", 91) --DT 3, Haste 4, STP 3, Crit 3, MDB 3
gear.perfectionLegs = hp_gear("Perfection Brais", 114)  --DT 6, Haste 9, STP 6, Crit 6, MDB 5
gear.perfectionFeet = hp_gear("Perfection Sab.", 79)    --DT 4, Haste 3, STP 4, Crit 4, MDB 5

--Pinga (Superior 3; WHM BLU SCH)
gear.pingaHead = hp_gear("Pinga Crown", 54)              --FC 8, Enmity -6, MDB 5, Cure Pot 8
gear.pingaHeadPlusOne = hp_gear("Pinga Crown +1", 74)    --FC 10, Enmity -7, MDB 6, Cure Pot 10
gear.pingaBody = hp_gear("Pinga Tunic", 81)              --FC 13, Enmity -8, MDB 8, Cure Pot 13
gear.pingaBodyPlusOne = hp_gear("Pinga Tunic +1", 101)   --FC 15, Cure Pot 15, MDB 9, Enmity -9
gear.pingaHands = hp_gear("Pinga Mittens", 33)           --FC 5, Enmity -5, MDB 4, Cure Pot 5
gear.pingaHandsPlusOne = hp_gear("Pinga Mittens +1", 53) --FC 7, Enmity -6, MDB 5, Cure Pot 7
gear.pingaLegs = hp_gear("Pinga Pants", 64)              --FC 11, Enmity -7, MDB 7, Cure Pot 11
gear.pingaLegsPlusOne = hp_gear("Pinga Pants +1", 84)    --FC 13, Cure Pot 13, MDB 8, Enmity -8
gear.pingaFeet = hp_gear("Pinga Pumps", 64)              --FC 3, Enmity -4, MDB 5, Cure Pot 3
gear.pingaFeetPlusOne = hp_gear("Pinga Pumps +1", 84)    --FC 5, Enmity -5, MDB 6, Cure Pot 5

--Pixie
gear.pixieHead = hp_gear("Pixie Hairpin +1", -35) --Dark MAB 28, INT 27

--Prestige (Limbus, Superior 4; WHM RDM PLD DRK BLU RUN)
gear.prestigeHead = hp_gear("Prestige Crown", 136)  --DT 6, Haste 5, FC 6, MAB 35, MDmg 31, MDB 5, Enspell Dmg 7
gear.prestigeBody = hp_gear("Prestige Plate.", 182) --DT 8, Haste 3, FC 8, MAB 35, MDmg 31, MDB 7, Enspell Dmg 9
gear.prestigeHands = hp_gear("Prestige Gaunt.", 91) --DT 4, Haste 5, FC 4, MAB 35, MDmg 31, MDB 4, Enspell Dmg 6
gear.prestigeLegs = hp_gear("Prestige Brais", 159)  --DT 7, Haste 5, FC 7, MAB 35, MDmg 31, MDB 6, Enspell Dmg 8
gear.prestigeFeet = hp_gear("Prestige Sab.", 114)   --DT 5, Haste 3, FC 5, MAB 35, MDmg 31, MDB 5, Enspell Dmg 6

--Raetic (Superior 3; MNK WHM BLM RDM THF DRK BRD RNG SMN BLU COR PUP DNC SCH GEO RUN)
gear.raeticHands = hp_gear("Raetic Bangles", 60)           --Haste 7, MDB 4, MP-fed damage absorption
gear.raeticHandsPlusOne = hp_gear("Raetic Bangles +1", 70) --Haste 7, MDB 5, Acc/Racc/Macc 55, MP-fed damage absorption

--Ratri (Superior 3; DRK)
gear.ratriHead = hp_gear("Ratri Sallet", 410)                  --Haste 7, WSD 6, Scythe Skill 44, DT +7, Regain 4
gear.ratriHeadPlusOne = hp_gear("Ratri Sallet +1", 510)     --WSD 8, Haste 7, Macc 45, Scythe Skill 54
gear.ratriBody = hp_gear("Ratri Plate", 433)                --Haste 3, WSD 8, DT-to-TP 8, Scythe Skill 46, DT +13
gear.ratriBodyPlusOne = hp_gear("Ratri Plate +1", 533)      --WSD 10, Haste 3, Macc 47, Scythe Skill 56
gear.ratriHands = hp_gear("Ratri Gadlings", 399)            --Haste 4, Enmity -7, WSD 6, Scythe Skill 43, DT +9
gear.ratriHandsPlusOne = hp_gear("Rat. Gadlings +1", 499)   --WSD 8, Haste 4, Macc 44, Enmity -10, Scythe Skill 53
gear.ratriLegs = hp_gear("Ratri Cuisses", 421)              --Haste 5, STP 7, WSD 7, Scythe Skill 45, DT +11
gear.ratriLegsPlusOne = hp_gear("Ratri Cuisses +1", 521)    --STP 10, WSD 9, Haste 5, Macc 46, Scythe Skill 55
gear.ratriFeet = hp_gear("Ratri Sollerets", 387)            --Haste 3, WSD 6, Scythe Skill 42, DT +5, Dark Dur 20
gear.ratriFeetPlusOne = hp_gear("Rat. Sollerets +1", 487)   --WSD 8, Haste 3, Macc 43, Scythe Skill 52

--Rawhide
gear.rawhideFeet = hp_gear("Rawhide Boots", 13) --Waltz 8%

--Regal (Omen; Pumps from Unity)
gear.regalCaptainGloves = hp_gear("Regal Cpt. Gloves", 182) --Haste 4, Acc 45, MDB 2, More attacks the lower the Acc
gear.regalGloves = hp_gear("Regal Gloves", 342)             --Haste 4, Acc 45, Racc 45, MDB 2, Dmg to TP 20, DT +20
gear.regalPumps = hp_gear("Regal Pumps", 13)                --Haste 3, FC 3, Meva 107, MDB 5, Healing/Enhancing Skill 10
gear.regalPumpsPlusOne = hp_gear("Regal Pumps +1", 13)      --Haste 3, FC 4, Meva 107, MDB 5, Healing/Enhancing Skill 11

--Revelation (Limbus, Superior 5; WAR BRD NIN)
gear.revelationHead = hp_gear("Revelation Masque", 107) --DT 6, Haste 6, STP 6, Crit 6, MDB 7
gear.revelationBody = hp_gear("Revelation Plate.", 130) --DT 8, Haste 4, STP 8, Crit 8, MDB 7
gear.revelationHands = hp_gear("Revelation Gaunt.", 96) --DT 4, Haste 4, STP 4, Crit 4, MDB 4
gear.revelationLegs = hp_gear("Revelation Brais", 119)  --DT 7, Haste 9, STP 7, Crit 7, MDB 6
gear.revelationFeet = hp_gear("Revelation Sab.", 84)    --DT 5, Haste 3, STP 5, Crit 5, MDB 6
...
--Sinister Reign
gear.dampeningTam = hp_gear("Dampening Tam", 36)            --Haste 7, SB 8, Acc 20, Racc 20, Macc 20, MDB 4, MDT 4
gear.founderCorona = hp_gear("Founder's Corona", 47)        --Haste 7, DA 2, Acc 20, Macc 20, Resist All 25, Killer 2
gear.jumalikHelm = hp_gear("Jumalik Helm", 45)              --Haste 7, PDT 5, MAB 20, Macc 20, MDmg 20, MDB 2, Divine magic Skill 20
gear.lilituHeadpiece = hp_gear("Lilitu Headpiece", 36)      --Haste 8, Enmity -5, SB 4, Att 20, MDB 2
gear.founderBreastplate = hp_gear("Found. Breastplate", 70) --Haste 3, DA 3, Acc 20, Att 20, Macc 20, MAB 20, MDB 4
gear.jumalikMail = hp_gear("Jumalik Mail", 66)              --DT 8, Haste 3, Cure Pot 15, Cure FC 10, MAB 20, MDB 4
gear.samnuhaCoat = hp_gear("Samnuha Coat", 63)              --Haste 4, Acc 23, Macc 23, MAB 20, MDB 6, Magic Burst II 8
gear.witchingRobe = hp_gear("Witching Robe", 50)            --Refresh 2, Haste 3, ConMP 5, MAB 25, MDB 7
gear.floralGauntlets = hp_gear("Floral Gauntlets", 25)      --Haste 5, DW 5, Acc 21, Racc 21, MDB 2
gear.founderGauntlets = hp_gear("Founder's Gauntlets", 31)  --Haste 4, DA 2, Counter 3, Att 20, MAB 20, Killer 2
gear.lengoPants = hp_gear("Lengo Pants", 43)                --Haste 5, FC 5, SIRD 10, ConMP 5, MAB 20, MDB 6
gear.talabTrousers = hp_gear("Ta'lab Trousers", 47)         --Haste 6, TA 3, Counter 3, Crit 2, Att 15, MDB 5
gear.ammGreaves = hp_gear("Amm Greaves", 75)                --DT 3, Haste 3, DA 3, MDB 2
gear.founderGreaves = hp_gear("Founder's Greaves", 20)      --Haste 3, DA 2, Acc 20, MAB 20, MDB 2, Killer 2
gear.loyalistSabatons = hp_gear("Loyalist Sabatons", 78)    --Haste 3, DA 4, Reward 35, Acc 18, Att 18, MDB 2
...
--Sworn (Limbus, Superior 5; WHM RDM PLD DRK BLU RUN)
gear.swornHead = hp_gear("Sworn Crown", 141)     --DT 7, Haste 5, FC 7, MAB 35, MDmg 32, MDB 6, Enspell Dmg 8
gear.swornBody = hp_gear("Sworn Platemail", 187) --DT 9, Haste 3, FC 9, MAB 35, MDmg 32, MDB 8, Enspell Dmg 10
gear.swornHands = hp_gear("Sworn Gauntlets", 96) --DT 5, Haste 5, FC 5, MAB 35, MDmg 32, MDB 5, Enspell Dmg 7
gear.swornLegs = hp_gear("Sworn Brais", 164)     --DT 8, Haste 5, FC 8, MAB 35, MDmg 32, MDB 7, Enspell Dmg 9
gear.swornFeet = hp_gear("Sworn Sabatons", 119)  --DT 6, Haste 3, FC 6, MAB 35, MDmg 32, MDB 6, Enspell Dmg 7
...
--Trust (Limbus, Superior 4; WHM RDM PLD DRK BLU RUN)
gear.trustHead = hp_gear("Trust Crown", 131)     --DT 5, Haste 5, FC 5, MAB 35, MDmg 30, MDB 4, Enspell Dmg 6
gear.trustBody = hp_gear("Trust Platemail", 177) --DT 7, Haste 3, FC 7, MAB 35, MDmg 30, MDB 6, Enspell Dmg 8
gear.trustHands = hp_gear("Trust Gauntlets", 86) --DT 3, Haste 5, FC 3, MAB 35, MDmg 30, MDB 3, Enspell Dmg 5
gear.trustLegs = hp_gear("Trust Brais", 154)     --DT 6, Haste 5, FC 6, MAB 35, MDmg 30, MDB 5, Enspell Dmg 7
gear.trustFeet = hp_gear("Trust Sabatons", 109)  --DT 4, Haste 3, FC 4, MAB 35, MDmg 30, MDB 4, Enspell Dmg 5

--Turms (Superior 3; THF DNC RUN)
gear.turmsHead = hp_gear("Turms Cap", 79)                 --Haste 6, Regen 6, MDB 6, Regain 4
gear.turmsHeadPlusOne = hp_gear("Turms Cap +1", 94)       --Haste 6, Regen 7, MDB 7, Regain 5
gear.turmsBody = hp_gear("Turms Harness", 114)            --Haste 4, STP 9, Regen 8, MDB 8
gear.turmsBodyPlusOne = hp_gear("Tu. Harness +1", 129)    --Haste 4, STP 12, Regen 9, MDB 9
gear.turmsHands = hp_gear("Turms Mittens", 59)            --Haste 4, Regen 5, MDB 4
gear.turmsHandsPlusOne = hp_gear("Turms Mittens +1", 74)  --Regen 6, Haste 4, MDB 5, Acc 49
gear.turmsLegs = hp_gear("Turms Subligar", 107)           --Haste 9, Crit 6, Regen 7, MDB 8
gear.turmsLegsPlusOne = hp_gear("Turms Subligar +1", 122) --Haste 9, Crit 8, Regen 8, MDB 9
gear.turmsFeet = hp_gear("Turms Leggings", 61)            --Haste 3, Regen 4, MDB 6, Inquartata 4
gear.turmsFeetPlusOne = hp_gear("Turms Leggings +1", 76)  --Haste 3, Regen 5, MDB 7, Inquartata 5

--Twilight (Set: Auto-Reraise)
gear.twilightHelm = hp_gear("Twilight Helm", 0) --All Stats 10, Att 25, Regen
gear.twilightMail = hp_gear("Twilight Mail", 0) --All Stats 15, Acc 25, Refresh

--Vagary
gear.rabidVisor = hp_gear("Rabid Visor", 38)               --Haste 8, Enmity 6, PDT 3, MDB 2
gear.countGarb = hp_gear("Count's Garb", 54)               --Haste 7, MAB 30, MDB 6, Magic Crit 15, Magic Crit Dmg 10
gear.supayWeskit = hp_gear("Supay Weskit", 54)             --Refresh 2, Haste 3, ConMP 5, MDmg 20, MDB 6
gear.tartarusPlatemail = hp_gear("Tartarus Platemail", 63) --DT 10, Haste 3, Acc 40, MDB 6, Absorbs Magic Dmg 5
gear.countCuffs = hp_gear("Count's Cuffs", 31)             --Haste 3, Counter 3, Martial Arts 5, Att 30, MDB 3, Guarding Skill 12
gear.crusherGauntlets = hp_gear("Crusher Gauntlets", 29)   --Haste 4, Acc 24, Att 24, Jumps: TP 25, Wyvern: HP 50
gear.avataraSlops = hp_gear("Avatara Slops", 43)           --Haste 5, Blood Boon 9, Blood Pact 7, MDB 6, Avatar: Enmity 4
gear.feastHose = hp_gear("Feast Hose", 43)                 --Haste 5, STP 4, Recycle 10, Enmity -3, Acc 23, Racc 23, MDB 6
gear.limboTrousers = hp_gear("Limbo Trousers", 47)         --Haste 6, FC 3, DA 2, Att 26, MAB 17, MDB 5
gear.miasmicPants = hp_gear("Miasmic Pants", 43)           --Haste 5, PDT 3, ConMP 4, Acc 22, Macc 22, MDB 6, Enchantment: Poison
gear.punchinellos = hp_gear("Punchinellos", 13)            --Haste 4, STP 5, Acc 20, MDB 5, Automaton: Acc 32, Racc 32
gear.defiantCollar = hp_gear("Defiant Collar", 0)          --Acc 8, SB 3, TA 1
gear.deviantNecklace = hp_gear("Deviant Necklace", 0)      --Acc 5, MAB 10, Enmity -5, ConMP 2
gear.famineSash = mp_gear("Famine Sash", 10)               --MP 10, Acc 10, Att 10, Macc 4
...
--Ambuscade
gear.ajjaKnife = rank_gear("Ajja Knife", 100)                                --Macc 20, Acc 20, Dagger Skill 223
gear.elettaKnife = rank_gear("Eletta Knife", 100)                            --MAB 10, Macc 30, MDmg 217, Acc 30, Att 20, Dagger Skill 231
gear.kajaKnife = rank_gear("Kaja Knife", 100)                                --Evisceration+ 50%
gear.ajjaKatana = rank_gear("Ajja Katana", 100)                              --Macc 20, Acc 20, Katana Skill 223
gear.elettaKatana = rank_gear("Eletta Katana", 100)                          --MAB 10, Macc 30, MDmg 217, Racc 30, Acc 30, Katana Skill 231
gear.kajaKatana = rank_gear("Kaja Katana", 100)                              --Blade: Ku 60%
gear.ajjaRod = rank_gear("Ajja Rod", 100)                                    --Macc 20, Acc 20, Club Skill 223
gear.elettaRod = rank_gear("Eletta Rod", 100)                                --MAB 15, Macc 30, MDmg 232, Acc 30, Club Skill 231
gear.kajaRod = rank_gear("Kaja Rod", 100)                                    --Black Halo +50%, substitutes for Maxentius; same rank so either beats HP offhands
gear.ajjaTachi = rank_gear("Ajja Tachi", 100)                                --Macc 20, Acc 20, Great Katana Skill 223
gear.elettaTachi = rank_gear("Eletta Tachi", 100)                            --Macc 30, Acc 30, Att 20, Great Katana Skill 231
gear.kajaTachi = rank_gear("Kaja Tachi", 100)                                --Macc 35, Acc 35, Att 25, Great Katana Skill 242, Parrying Skill 242
gear.hachimonji = rank_gear("Hachimonji", 100)                               --Macc 40, Acc 40, Att 30, STR/DEX/VIT 20, Tachi: Kasha 25%
gear.ajjaKnuckles = rank_gear("Ajja Knuckles", 100)                          --Macc 20, Acc 20, Hand Skill 223
gear.elettaKnuckles = rank_gear("Eletta Knuckles", 100)                      --Macc 30, Acc 30, Att 20, Hand Skill 231
gear.kajaKnuckles = rank_gear("Kaja Knuckles", 100)                          --Macc 35, Acc 35, Att 25, STR/DEX/VIT 15, Asuran Fists 50%
gear.ajjaSword = rank_gear("Ajja Sword", 100)                                --Macc 20, Acc 20, Sword Skill 223
gear.elettaSword = rank_gear("Eletta Sword", 100)                            --MAB 10, Macc 30, MDmg 217, Acc 30, Att 20, Sword Skill 231
gear.kajaSword = rank_gear("Kaja Sword", 100)                                --MAB 13, Macc 35, MDmg 217, Acc 35, Att 25, Savage Blade 15%
gear.ajjaClaymore = rank_gear("Ajja Claymore", 100)                          --Macc 20, Acc 20, Great Sword Skill 223
gear.elettaClaymore = rank_gear("Eletta Claymore", 100)                      --MAB 10, Macc 30, MDmg 217, Acc 30, Att 20, Great Sword Skill 231
gear.kajaClaymore = rank_gear("Kaja Claymore", 100)                          --MAB 18, Macc 35, MDmg 226, Acc 35, Att 25, Ground Strike 15%
gear.nandaka = rank_gear("Nandaka", 100)                                     --MAB 21, Macc 40, MDmg 226, Acc 40, Att 30, Ground Strike 15%
gear.ajjaAxe = rank_gear("Ajja Axe", 100)                                    --Macc 20, Acc 20, Axe Skill 223
gear.elettaAxe = rank_gear("Eletta Axe", 100)                                --MAB 10, Macc 30, MDmg 217, Acc 30, Att 20, Axe Skill 231
gear.kajaAxe = rank_gear("Kaja Axe", 100)                                    --MAB 13, Macc 35, MDmg 217, Acc 35, Att 25, Decimation 120%
gear.ajjaChopper = rank_gear("Ajja Chopper", 100)                            --Macc 20, Acc 20, Great Axe Skill 223
gear.elettaChopper = rank_gear("Eletta Chopper", 100)                        --Macc 30, Acc 30, Att 20, Great Axe Skill 231
gear.kajaChopper = rank_gear("Kaja Chopper", 100)                            --Macc 35, Acc 35, Att 25, STR/DEX/VIT 15, Steel Cyclone 30%
gear.ajjaScythe = rank_gear("Ajja Scythe", 100)                              --Macc 20, Acc 20, Scythe Skill 223
gear.elettaScythe = rank_gear("Eletta Scythe", 100)                          --MAB 10, Macc 30, MDmg 217, Acc 30, Att 20, Scythe Skill 231
gear.kajaScythe = rank_gear("Kaja Scythe", 100)                              --MAB 18, Macc 35, MDmg 226, Acc 35, Att 25, Spiral Hell 100%
gear.drepanum = rank_gear("Drepanum", 100)                                   --MAB 21, Macc 40, MDmg 226, Acc 40, Att 30, Spiral Hell 100%
gear.ajjaLance = rank_gear("Ajja Lance", 100)                                --Macc 20, Acc 20, Polearm Skill 223
gear.elettaLance = rank_gear("Eletta Lance", 100)                            --MAB 10, Macc 30, MDmg 217, Acc 30, Att 20, Polearm Skill 231
gear.kajaLance = rank_gear("Kaja Lance", 100)                                --MAB 18, Macc 35, MDmg 226, Acc 35, Att 25, Impulse Drive 40%
gear.ajjaStaff = rank_gear("Ajja Staff", 100)                                --Macc 20, Acc 20, Staff Skill 223
gear.elettaStaff = rank_gear("Eletta Staff", 100)                            --MAB 15, Macc 30, MDmg 232, Acc 30, Staff Skill 231
gear.kajaStaff = rank_gear("Kaja Staff", 100)                                --MAB 23, Macc 35, MDmg 241, Acc 35, INT/MND/CHR 15, Retribution 20%
gear.ajjaBow = hp_gear("Ajja Bow", 0)                                        --Macc 20, Racc 20, Archery Skill 223
gear.elettaBow = hp_gear("Eletta Bow", 0)                                    --Macc 30, Racc 30, Ratt 20, Archery Skill 231
gear.kajaBow = hp_gear("Kaja Bow", 0)                                        --Macc 35, Racc 35, Ratt 25, STR/DEX/AGI 10, Empyreal Arrow 50%
gear.ajjaGrip = hp_gear("Ajja Grip", 0)                                      --Acc 15, Macc 15, DT 3
gear.elettaGrip = hp_gear("Eletta Grip", 0)                                  --Acc 20, Macc 20, Enmity -3, DT 4
gear.kajaGrip = hp_gear("Kaja Grip", 0)                                      --Acc 25, Macc 25, Enmity -4, DT 5
gear.khonsu = hp_gear("Khonsu", 0)                                           --Haste 4, Acc 30, Macc 30, Enmity -5, DT 6
...
gear.ligeiaScythe = rank_gear("Ligeia Scythe", 100)                          --Acc 28, Macc 28, Wind Res 28, Songs Crit 10
...
--Aeonic
gear.heishiShorinken = rank_gear("Heishi Shorinken", 100)                    --STP 10, MDmg 186, Katana Skill 269, Parrying Skill 269, Magic Accuracy Skill 242
gear.khatvanga = rank_gear("Khatvanga", 100)                                 --Occult Acumen 30, TP Bonus 500, MDmg 279, Staff Skill 269, Parrying Skill 269
gear.lionheart = rank_gear("Lionheart", 100)                                 --STP 10, MDmg 186, Great Sword Skill 269, Parrying Skill 269, Magic Accuracy Skill 242
gear.sequence = rank_gear("Sequence", 100)                                   --STP 10, MDmg 186, Sword Skill 269, Parrying Skill 269, Magic Accuracy Skill 242
gear.tishtrya = rank_gear("Tishtrya", 100)                                   --STP 10, MDmg 217, Club Skill 269, Parrying Skill 269, Magic Accuracy Skill 255
gear.triEdge = rank_gear("Tri-edge", 100)                                    --STP 10, MDmg 155, Axe Skill 269, Parrying Skill 269, Magic Accuracy Skill 228
...
gear.ankusaAxe = rank_gear("Ankusa Axe", 100)                 --BST
gear.archmageStaff = rank_gear("Archmage's Staff", 100)       --BLM
gear.arguteStaff = rank_gear("Argute Staff", 100)             --SCH
gear.arkeCrossbow = hp_gear("Arke Crossbow", 140)             --RNG
gear.assassinKnife = rank_gear("Assassin's Knife", 100)       --THF
gear.augeAxe = rank_gear("Auge Axe", 100)                     --BST
gear.augeBow = hp_gear("Auge Bow", 0)                         --RNG
gear.augeChopper = rank_gear("Auge Chopper", 100)             --WAR
gear.augeClaymore = rank_gear("Auge Claymore", 100)           --WAR PLD DRK RUN
gear.augeGrip = rank_gear("Auge Grip", 99)                    --any job; rank augments reach HP+100, held under the weapon rank
gear.augeHalberd = rank_gear("Auge Halberd", 100)             --DRG
gear.augeKatana = rank_gear("Auge Katana", 100)               --SAM
gear.augeKnife = rank_gear("Auge Knife", 100)                 --RDM THF BRD DNC
gear.augeKnuckles = rank_gear("Auge Knuckles", 100)           --MNK PUP
gear.augeMaul = rank_gear("Auge Maul", 100)                   --WHM GEO
gear.augeSaber = rank_gear("Auge Saber", 100)                 --RDM BLU COR
gear.augeScythe = rank_gear("Auge Scythe", 100)               --DRK
gear.augeShield = rank_gear("Auge Shield", 99)                --PLD; rank augments reach HP+150, held under the weapon rank; DT II 3, Haste 3, Shield Skill 121
gear.augeShinobiGatana = rank_gear("Auge Shin.", 100)         --NIN
gear.augeStaff = rank_gear("Auge Staff", 100)                 --BLM SMN SCH
gear.augeSword = rank_gear("Auge Sword", 100)                 --WAR PLD DRK
gear.baguaWand = rank_gear("Bagua Wand", 100)                 --GEO
gear.bardKnife = rank_gear("Bard's Knife", 100)               --BRD
gear.bihuKnife = rank_gear("Bihu Knife", 100)                 --BRD
gear.caballariusSword = rank_gear("Cabal. Sword", 100)        --PLD
gear.clericWand = rank_gear("Cleric's Wand", 100)             --WHM
gear.commodoreKnife = rank_gear("Comm. Knife", 100)           --COR
gear.daduchosAxe = rank_gear("Daduchos Axe", 100)             --BST
gear.daduchosBow = hp_gear("Daduchos Bow", 0)                 --RNG
gear.daduchosChopper = rank_gear("Daduchos Chopper", 100)     --WAR
gear.daduchosClaymore = rank_gear("Daduchos Claymore", 100)   --WAR PLD DRK RUN
gear.daduchosGrip = rank_gear("Daduchos Grip", 99)            --any job; rank augments reach HP+100, held under the weapon rank
gear.daduchosHalberd = rank_gear("Daduchos Halberd", 100)     --DRG
gear.daduchosKatana = rank_gear("Daduchos Katana", 100)       --SAM
gear.daduchosKnife = rank_gear("Daduchos Knife", 100)         --RDM THF BRD DNC
gear.daduchosKnuckles = rank_gear("Daduchos Knuckles", 100)   --MNK PUP
gear.daduchosMaul = rank_gear("Daduchos Maul", 100)           --WHM GEO
gear.daduchosSaber = rank_gear("Daduchos Saber", 100)         --RDM BLU COR
gear.daduchosScythe = rank_gear("Daduchos Scythe", 100)       --DRK
gear.daduchosShield = rank_gear("Daduchos Shield", 99)        --PLD; rank augments reach HP+150, held under the weapon rank; DT II 4, Haste 4, Shield Skill 121
gear.daduchosShinobiGatana = rank_gear("Daduchos Shin.", 100) --NIN
gear.daduchosStaff = rank_gear("Daduchos Staff", 100)         --BLM SMN SCH
gear.daduchosSword = rank_gear("Daduchos Sword", 100)         --WAR PLD DRK
gear.duelistSword = rank_gear("Duelist's Sword", 100)         --RDM
gear.etoileKnife = rank_gear("Etoile Knife", 100)             --DNC
gear.fallenScythe = rank_gear("Fallen's Scythe", 100)         --DRK
gear.futharkClaymore = rank_gear("Futhark Claymore", 100)     --RUN
gear.glyphicStaff = rank_gear("Glyphic Staff", 100)           --SMN
gear.hesychastFists = rank_gear("Hes. Fists", 100)            --MNK
gear.horosKnife = rank_gear("Horos Knife", 100)               --DNC
gear.kogaShinobiGatana = rank_gear("Koga Shin.", 100)         --NIN
gear.lanunKnife = rank_gear("Lanun Knife", 100)               --COR
gear.luhlazaSword = rank_gear("Luhlaza Sword", 100)           --BLU
gear.meleeFists = rank_gear("Melee Fists", 100)               --MNK
gear.mirageSword = rank_gear("Mirage Sword", 100)             --BLU
gear.mochizukiShinobiGatana = rank_gear("Mochi. Shin.", 100)  --NIN
gear.monsterAxe = rank_gear("Monster Axe", 100)               --BST
gear.pantinFists = rank_gear("Pantin Fists", 100)             --PUP
gear.pedagogyStaff = rank_gear("Pedagogy Staff", 100)         --SCH
gear.peordClaymore = rank_gear("Peord Claymore", 100)         --RUN
gear.pietyWand = rank_gear("Piety Wand", 100)                 --WHM
gear.pitreFists = rank_gear("Pitre Fists", 100)               --PUP
gear.plundererKnife = rank_gear("Plun. Knife", 100)           --THF
gear.pteroslaverLance = rank_gear("Pteroslaver Lance", 100)   --DRG
gear.sakonjiNoTachi = rank_gear("Sakonji-no-Tachi", 100)      --SAM
gear.saotomeNoTachi = rank_gear("Saotome-no-Tachi", 100)      --SAM
gear.scoutCrossbow = hp_gear("Scout's Crossbow", 130)         --RNG
gear.sifangWand = rank_gear("Sifang Wand", 100)               --GEO
gear.sorcererStaff = rank_gear("Sorcerer's Staff", 100)       --BLM
gear.summonerStaff = rank_gear("Summoner's Staff", 100)       --SMN
gear.valorSword = rank_gear("Valor Sword", 100)               --PLD
gear.vitiationSword = rank_gear("Vitiation Sword", 100)       --RDM
gear.warriorChopper = rank_gear("War. Chopper", 100)          --WAR
gear.wyrmLance = rank_gear("Wyrm Lance", 100)                 --DRG

--Superior 5
gear.aram = rank_gear("Aram", 100)                              --DRG
gear.barfawc = rank_gear("Barfawc", 100)                        --BRD
gear.bhima = rank_gear("Bhima", 100)                            --GEO
gear.draumstafir = rank_gear("Draumstafir", 100)                --SMN
gear.fatherTime = rank_gear("Father Time", 100)                 --DRK
gear.fudoMasamune = rank_gear("Fudo Masamune", 100)             --NIN
gear.fusenaikyo = rank_gear("Fusenaikyo", 100)                  --SAM
gear.gandring = rank_gear("Gandring", 100)                      --THF
gear.kaumodaki = rank_gear("Kaumodaki", 100)                    --BLM
gear.moralltach = rank_gear("Moralltach", 100)                  --PLD
gear.morgelai = rank_gear("Morgelai", 100)                      --RUN
gear.sagitta = rank_gear("Sagitta", 100)                        --MNK
gear.scoutBolt = hp_gear("Scout's Bolt", 0)                     --RNG
gear.setanKober = rank_gear("Setan Kober", 100)                 --DNC
gear.sharanga = hp_gear("Sharanga", 150)                        --RNG
gear.telopanosAxe = rank_gear("Telopanos Axe", 100)             --BST
gear.telopanosBow = hp_gear("Telopanos Bow", 0)                 --RNG
gear.telopanosChopper = rank_gear("Telopanos Chopper", 100)     --WAR
gear.telopanosClaymore = rank_gear("Telopanos Claymore", 100)   --WAR PLD DRK RUN
gear.telopanosGrip = rank_gear("Telopanos Grip", 99)            --any job; rank augments reach HP+100, held under the weapon rank
gear.telopanosHalberd = rank_gear("Telopanos Halberd", 100)     --DRG
gear.telopanosKatana = rank_gear("Telopanos Katana", 100)       --SAM
gear.telopanosKnife = rank_gear("Telopanos Knife", 100)         --RDM THF BRD DNC
gear.telopanosKnuckles = rank_gear("Telopanos Knuckles", 100)   --MNK PUP
gear.telopanosMaul = rank_gear("Telopanos Maul", 100)           --WHM GEO
gear.telopanosSaber = rank_gear("Telopanos Saber", 100)         --RDM BLU COR
gear.telopanosScythe = rank_gear("Telopanos Scythe", 100)       --DRK
gear.telopanosShield = rank_gear("Telopanos Shield", 99)        --PLD; rank augments reach HP+150, held under the weapon rank; DT II 5, Haste 5, Shield Skill 121
gear.telopanosShinobiGatana = rank_gear("Telopanos Shin.", 100) --NIN
gear.telopanosStaff = rank_gear("Telopanos Staff", 100)         --BLM SMN SCH
gear.telopanosSword = rank_gear("Telopanos Sword", 100)         --WAR PLD DRK
gear.xiucoatl = rank_gear("Xiucoatl", 100)                      --PUP
gear.zomorrodnegar = rank_gear("Zomorrodnegar", 100)            --BLU

--Prime
gear.dokoku = rank_gear("Dokoku", 100)                  --STP 10, Acc 35, Macc 35, MDmg 263, Katana Skill 277
gear.foenaria = rank_gear("Foenaria", 100)              --TA 6, Acc 35, Macc 35, Scythe Skill 277
gear.gaeBuide = rank_gear("Gae Buide", 100)             --DA 10, Acc 35, Macc 35, Polearm Skill 277, Wyvern: Acc 35, Lvl +3
gear.genshitanto = rank_gear("Genshitanto", 100)        --Katana Skill 252, Parrying Skill 252, Magic Accuracy Skill 252
gear.genshito = rank_gear("Genshito", 100)              --Great Katana Skill 252, Parrying Skill 252, Magic Accuracy Skill 252
gear.helheim = rank_gear("Helheim", 100)                --STP 7, Acc 30, Macc 30, Great Sword Skill 269
gear.kusanagi = rank_gear("Kusanagi", 100)              --DA 10, Acc 35, Macc 35, Great Katana Skill 277
gear.laphria = rank_gear("Laphria", 100)                --DA 10, Acc 35, Macc 35, Great Axe Skill 277
gear.pinaka = hp_gear("Pinaka", 0)                      --STP 10, Acc 35, Macc 35, Archery Skill 277
gear.primeBlade = rank_gear("Prime Blade", 100)         --Great Sword Skill 252, Parrying Skill 252, Magic Accuracy Skill 252
gear.primeBow = hp_gear("Prime Bow", 0)                 --Archery Skill 252
gear.primeDagger = rank_gear("Prime Dagger", 100)       --Dagger Skill 252, Parrying Skill 252, Magic Accuracy Skill 252
gear.primeFists = rank_gear("Prime Fists", 100)         --Hand-to-Hand Skill 252, Guarding Skill 252, Magic Accuracy Skill 252
gear.primeGreatAxe = rank_gear("Prime Great Axe", 100)  --Great Axe Skill 252, Parrying Skill 252, Magic Accuracy Skill 252
gear.primeGun = hp_gear("Prime Gun", 0)                 --Marksmanship Skill 252
gear.primeHorn = hp_gear("Prime Horn", 0)               --CHR 3
gear.primeLance = rank_gear("Prime Lance", 100)         --Polearm Skill 252, Parrying Skill 252, Magic Accuracy Skill 252
gear.primeMaul = rank_gear("Prime Maul", 100)           --Club Skill 252, Parrying Skill 252, Magic Accuracy Skill 252
gear.primePickaxe = rank_gear("Prime Pickaxe", 100)     --Axe Skill 252, Parrying Skill 252, Magic Accuracy Skill 252
gear.primeScythe = rank_gear("Prime Scythe", 100)       --Scythe Skill 252, Parrying Skill 252, Magic Accuracy Skill 252
gear.primeShield = hp_gear("Prime Shield", 0)           --Shield Skill 118
gear.primeStaff = rank_gear("Prime Staff", 100)         --Staff Skill 252, Parrying Skill 252, Magic Accuracy Skill 252
gear.primeSword = rank_gear("Prime Sword", 100)         --Sword Skill 252, Parrying Skill 252, Magic Accuracy Skill 252
gear.spalirisos = rank_gear("Spalirisos", 100)          --Crit 15, Acc 35, Macc 35, Axe Skill 277, Pet: Acc 35, Lvl +3
gear.vargaPurnikawa = rank_gear("Varga Purnikawa", 100) --Crit 15, Acc 35, Macc 35, Hand-to-Hand Skill 277, Automaton: Lvl +3

--Sinister Reign
gear.brilliance = rank_gear("Brilliance", 100)                 --DT 3, Enmity 7, Enlight 15, MAB 14, MDmg 108, Sword Skill 242
gear.brutality = rank_gear("Brutality", 100)                   --TA 2, Regen 3, Souleater 2, Att 25, Scythe Skill 242
gear.divinity = rank_gear("Divinity", 100)                     --Cure Pot 15, Macc 20, MAB 14, MDmg 108, Healing magic Skill 20, Divine magic Skill 20
gear.ferocity = rank_gear("Ferocity", 100)                     --DA 3, Regen 3, Att 25, STR 20, VIT 20, Great Axe Skill 242
gear.fleshcarvers = rank_gear("Fleshcarvers", 100)             --Crit 4, Martial Arts 3, DEX 17, Att 30, Hand-to-Hand Skill 242
gear.himetsuruichimonji = rank_gear("Himetsuruichimonji", 100) --DA 3, TA 2, Zanshin 7, Great Katana Skill 242
gear.humility = rank_gear("Humility", 100)                     --Enmity 7, Meva 25, Acc 15, Att 15, Great Sword Skill 242
gear.koresuke = rank_gear("Koresuke", 100)                     --DA 3, Zanshin 6, Acc 15, High Jump Enmity -10, Polearm Skill 242
gear.malevolence = rank_gear("Malevolence", 100)               --Macc 25, MAB 34, MDmg 118, Undead Killer 10, Dagger Skill 242
gear.nobility = hp_gear("Nobility", 0)                         --SB 12, Recycle 15, Racc 25, STR 19, AGI 19, Archery Skill 242
gear.ochu = rank_gear("Ochu", 100)                             --SB 8, Magic Burst II 13, Acc 20, Racc 20, MAB 14, MDmg 108, Katana Skill 242
gear.purgation = rank_gear("Purgation", 100)                   --DA 3, MDT 4, Acc 20, Undead Killer 10, Axe Skill 242
gear.rubicundity = rank_gear("Rubicundity", 100)               --Drain/Aspir 20, Macc 20, MAB 16, MDmg 124, Dark magic Skill 15, Club Skill 242
gear.serenity = rank_gear("Serenity", 100)                     --Cure Pot 25, Enmity -5, Macc 25, MAB 28, MDmg 217, Staff Skill 242
gear.tamingSari = rank_gear("Taming Sari", 100)                --TA 3, SB 8, Acc 20, Att 20, MAB 14, MDmg 108, Dagger Skill 242
gear.vampirism = rank_gear("Vampirism", 100)                   --FC 7, MAB 34, MDmg 108, Att 23, STR 15, Sword Skill 242

--Vagary
gear.acclimator = rank_gear("Acclimator", 100)     --Chain Affinity 10, Skillchain Bonus 10, Acc 15, Macc 15, MDmg 96
gear.achiuchikapu = rank_gear("Achiuchikapu", 100) --DA 4, STP 5, SB 8, Acc 34, Eva 27, Katana Skill 228
gear.brahmastra = hp_gear("Brahmastra", 30)        --SB 5, Acc 20, Racc 20, STR 10, AGI 10, Archery Skill 242
gear.devivifier = rank_gear("Devivifier", 100)     --DA 5, DA Dmg 15, Acc 25, STR 15, Great Axe Skill 242
gear.focalOrb = hp_gear("Focal Orb", 0)            --DA 2, Att 10, Acc -10
gear.meekculler = rank_gear("Meekculler", 100)     --PDT 4, Acc 15, Att 20, Macc 15, Scythe Skill 242
gear.mindmelter = rank_gear("Mindmelter", 100)     --MAB 28, MDmg 217, Staff Skill 242, Poison: MAB 43, Macc 15, ConMP 4
gear.odium = rank_gear("Odium", 100)               --All Stats 13, Acc 13, Att 13, Death Res 13, Additional Effect: Death, Dagger Skill 242
gear.rhadamanthus = rank_gear("Rhadamanthus", 100) --Waltz 7, Acc 13, Eva 22, Meva 20, DEX 12, AGI 12, Dagger Skill 242
gear.soulcleaver = rank_gear("Soulcleaver", 100)   --Lunge 10, MAB 20, MDmg 150, Att 26, Eva 25, Great Sword Skill 228
gear.umbraStrap = hp_gear("Umbra Strap", 20)       --DT 1, MP 20, Acc 3
...
gear.srodaTathlum = hp_gear("Sroda Tathlum", 0)        --Magic Crit II 10, Macc -10, Meva -10
gear.staunchPlusOne = hp_gear("Staunch Tathlum +1", 0) --DT 3, SIRD 11

--Neck
gear.adoulinRefuge = hp_gear("Adoulin's Refuge", 0)           --Reives: Auto-Reraise
gear.adoulinRefugePlusOne = hp_gear("Adoulin's Refuge +1", 0) --Reives: DT 8, Auto-Reraise
gear.aesirTorque = hp_gear("Aesir Torque", 0)                 --Dark Res 20, Elemental/Dark Skill 7, Darksday Skill 10
gear.anu = hp_gear("Anu Torque", 0)                           --STP 7, Atk 20
gear.arcielaGrace = hp_gear("Arciela's Grace", 0)             --Reives: Regen 10, Refresh 10
gear.arcielaGracePlusOne = hp_gear("Arciela's Grace +1", 0)   --Reives: MDmg 80, Cure Pot 25, Regen 10, Refresh 10
gear.arguteStolePlusTwo = hp_gear("Argute Stole +2", 0)       --Macc 30, MDmg 4-7, Magic Burst Damage 10, Helix Effect Dur 4-7
gear.ashuraNecklace = hp_gear("Ashura Necklace", 0)           --STR/DEX/VIT/AGI 1
...
gear.bardCharmPlusTwo = hp_gear("Bard's Charm +2", 0)         --QA 4, STP 7, PDL 10, Acc 30, DEX/CHR 25
gear.baguaCharmPlusTwo = mp_gear("Bagua Charm +2", 50)        --Augment MP+50, Macc 30, Geomancy 7, Luopan Dur 25, Luopan DT 10
gear.colossusTorque = hp_gear("Colossus's Torque", 0)         --Light Res 20, Healing/Enhancing Skill 7, Lightsday Skill 10
gear.commodoreCharmPlusTwo = hp_gear("Comm. Charm +2", 0)     --Racc 25, Macc 25, MAB 6, Snapshot 4, STR/AGI 14
...
gear.dragoonCollarPlusTwo = hp_gear("Dgn. Collar +2", 0)      --Acc 25, Att 25, Crit 4, STR/VIT 15, PDL 10, Wyvern DT 25
gear.duelistTorquePlusTwo = hp_gear("Dls. Torque +2", 0)      --Enhancing Dur 25%, Enfeebling Dur 25%, Enfeebling 10, Dispel +1,
gear.eliteRoyalCollar = hp_gear("Elite Royal Collar", 0)      --DT 5, VIT 10, San d'Orian Regen 3
...
gear.etoileGorgetPlusTwo = hp_gear("Etoile Gorget +2", 0)     --Macc 25, Acc 25, Waltz 10
...
gear.knightsBeadPlusTwo = hp_gear("Kgt. Beads +2", 60)        --Augment HP+60, VIT/MND 15, DT 7, Enmity 10
...
gear.mirageStolePlusTwo = hp_gear("Mirage Stole +2", 0)       --STP 6, Crit 4
gear.monkNodowaPlusTwo = hp_gear("Monk's Nodowa +2", 0)       --Kick Attacks +45, PDL 10, DEX/MND 15, Acc 30
...
gear.nesanicaTorque = hp_gear("Nesanica Torque", 0)           --Light Res 20, Divine/Healing Skill 7, Lightsday Skill 10
...
gear.puppetmasterCollarPlusTwo = hp_gear("Pup. Collar +2", 0) --Acc 30, Pet Acc/Racc/Macc 25
...
gear.scoutGorgetPlusTwo = hp_gear("Scout's Gorget +2", 0)     --Racc 25, Macc 25, Snapshot 4, AGI 13-25, STP 4-10, PDL 5-10
gear.srodaNecklace = hp_gear("Sroda Necklace", 0)             --Ailment Resist Magic 20, Enhancing Dur -50
...
gear.warriorsBeadPlusTwo = hp_gear("War. Beads +2", 100)      --Augment HP+100, STR/DEX 15, DA 7, Fencer 1
gear.ygnasResolve = hp_gear("Ygnas's Resolve", 0)             --Reives: Regain 30
gear.ygnasResolvePlusOne = hp_gear("Ygnas's Resolve +1", 0)   --Reives: Regain 30, WSD 25

--Dynamis - Divergence
gear.warriorsBead = hp_gear("Warrior's Beads", 0)                --Acc 15, Att 15, Fencer 1
gear.warriorsBeadPlusOne = hp_gear("War. Beads +1", 0)           --Acc 20, Att 20, Fencer 1
gear.monkNodowa = hp_gear("Monk's Nodowa", 0)                    --Acc 20, Kick Attacks Att 10
gear.monkNodowaPlusOne = hp_gear("Mnk. Nodowa +1", 0)            --Acc 25, Kick Attacks Att 15
gear.clericTorque = mp_gear("Cleric's Torque", 30)               --Cure Pot 5, Erase 1
gear.clericTorquePlusOne = mp_gear("Clr. Torque +1", 40)         --Cure Pot 7, Erase 1
gear.sorcererStole = hp_gear("Sorcerer's Stole", 0)              --MAB 3, Macc 20
gear.sorcererStolePlusOne = hp_gear("Src. Stole +1", 0)          --MAB 5, Macc 25
gear.duelistTorque = hp_gear("Duelist's Torque", 0)              --Macc 20, Enfeebling 5, Dispel 1
gear.duelistTorquePlusOne = hp_gear("Dls. Torque +1", 0)         --Macc 25, Enfeebling 7, Dispel 1
gear.assassinGorget = hp_gear("Assassin's Gorget", 0)            --Macc 15, Acc 15, TA Damage 3
gear.assassinGorgetPlusOne = hp_gear("Asn. Gorget +1", 0)        --Macc 20, Acc 20, TA Damage 4
gear.knightsBead = hp_gear("Knight's Beads", 0)                  --Enmity 5
gear.knightsBeadPlusOne = hp_gear("Kgt. Beads +1", 0)            --Enmity 7
gear.abyssalBeadNecklace = hp_gear("Abyssal Beads", 0)           --Macc 5, Acc 5, Att 30, Crit 2
gear.abyssalBeadNecklacePlusOne = hp_gear("Abyssal Beads +1", 0) --Macc 10, Acc 10, Att 35, Crit 3
gear.beastmasterCollar = hp_gear("Beastmaster Collar", 0)        --Macc 15, Acc 15, Pet Acc/Racc/Macc 15
gear.beastmasterCollarPlusOne = hp_gear("Bst. Collar +1", 0)     --Macc 20, Acc 20, Pet Acc/Racc/Macc 20
gear.bardCharm = hp_gear("Bard's Charm", 0)                      --QA 1, Acc 20
gear.bardCharmPlusOne = hp_gear("Bard's Charm +1", 0)            --QA 2, Acc 25
gear.scoutGorget = hp_gear("Scout's Gorget", 0)                  --Racc 15, Macc 15, Snapshot 2
gear.scoutGorgetPlusOne = hp_gear("Scout's Gorget +1", 0)        --Racc 20, Macc 20, Snapshot 3
gear.samuraiNodowa = hp_gear("Samurai's Nodowa", 0)              --STP 3, Acc 20
gear.samuraiNodowaPlusOne = hp_gear("Sam. Nodowa +1", 0)         --STP 5, Acc 25
gear.ninjaNodowa = hp_gear("Ninja Nodowa", 0)                    --STP 3, Racc 15, Acc 15
gear.ninjaNodowaPlusOne = hp_gear("Ninja Nodowa +1", 0)          --STP 5, Racc 20, Acc 20
gear.dragoonCollar = hp_gear("Dragoon's Collar", 0)              --Acc 15, Att 15, Crit 2, Wyvern Lv 1
gear.dragoonCollarPlusOne = hp_gear("Dgn. Collar +1", 0)         --Acc 20, Att 20, Crit 3, Wyvern Lv 1
gear.summonerCollar = hp_gear("Summoner's Collar", 30)           --DT 3, Avatar Acc/Racc/Macc 15
gear.summonerCollarPlusOne = hp_gear("Smn. Collar +1", 40)       --DT 4, Avatar Acc/Racc/Macc 20
gear.mirageStole = hp_gear("Mirage Stole", 0)                    --Macc 15, Acc 15, Blue Magic 10
gear.mirageStolePlusOne = hp_gear("Mirage Stole +1", 0)          --Macc 20, Acc 20, Blue Magic 15
gear.commodoreCharm = hp_gear("Commodore Charm", 0)              --Racc 15, Macc 15, Snapshot 2
gear.commodoreCharmPlusOne = hp_gear("Comm. Charm +1", 0)        --Racc 20, Macc 20, Snapshot 3
gear.puppetmasterCollar = hp_gear("Pup. Collar", 0)              --Acc 20, Automaton Acc/Racc/Macc 15
gear.puppetmasterCollarPlusOne = hp_gear("Pup. Collar +1", 0)    --Acc 25, Automaton Acc/Racc/Macc 20
gear.etoileGorget = hp_gear("Etoile Gorget", 0)                  --Macc 15, Acc 15, Waltz Pot 5
gear.arguteStole = hp_gear("Argute Stole", 0)                    --Macc 20, Magic Burst Damage 5
gear.arguteStolePlusOne = hp_gear("Argute Stole +1", 0)          --Macc 25, Magic Burst Damage 7
gear.baguaCharm = hp_gear("Bagua Charm", 0)                      --Macc 20, Geomancy 5
gear.baguaCharmPlusOne = hp_gear("Bagua Charm +1", 0)            --Macc 25, Geomancy 6
gear.futharkTorque = hp_gear("Futhark Torque", 0)                --Meva 20, Enmity 5
...
--Ear
gear.abyssalEarring = hp_gear("Abyssal Earring", 0)      --INT 2, Scythe Skill 5, Dark Magic Skill 5
gear.aesirEarPendant = hp_gear("Aesir Ear Pendant", 0)   --Att 7, Conserve TP 3, Dark Weather Conserve TP 6
gear.alabaster = hp_gear("Alabaster Earring", 100)       --DT 5, Haste 5
gear.beastlyEarring = hp_gear("Beastly Earring", 0)      --CHR 2, Eva 5, Axe Skill 5
gear.brutal = hp_gear("Brutal Earring", 0)               --DA 5, STP 1
gear.bushinomimi = hp_gear("Bushinomimi", 0)             --STR 2, Great Katana Skill 5, Parrying Skill 5
gear.cessance = hp_gear("Cessance Earring", 0)           --DA 3, STP 3
gear.colossusEarring = hp_gear("Colossus's Earring", 10) --PDT 1, Light Weather PDT 2, MP 10
gear.crepuscularEar = hp_gear("Crepuscular Earring", 0)  --STP 5
gear.dedition = hp_gear("Dedition Earring", 0)           --STP 8, Acc -10, Att -10, Racc -10, Ratt -10
...
gear.hollowEarring = hp_gear("Hollow Earring", 0)        --DEX 2, Acc 3, Racc 3, Sword Enspell Dmg 3
gear.hoxneEar = hp_gear("Hoxne Earring", 0)              --30 All Stats at MR 10
gear.ishvara = hp_gear("Ishvara Earring", 0)             --WSD 2
gear.knightsEarring = hp_gear("Knight's Earring", 0)     --VIT 2, Shield Skill 5, Divine Magic Skill 5
gear.lempo = hp_gear("Lempo Earring", 0)                 --Acc 5, Macc 5, Enmity -3, Conserve MP 2
gear.loquacious = mp_gear("Loquacious Earring", 30)      --FC 2
gear.lugra = hp_gear("Lugra Earring", 0)                 --Dusk to dawn: STR/DEX/VIT/INT 7, Unity Ranking DA 1~3
gear.lugraPlusOne = hp_gear("Lugra Earring +1", 0)       --Dusk to dawn: STR/DEX/VIT/INT 8, Unity Ranking DA 1~3
...
gear.staticEarring = hp_gear("Static Earring", 0)        --MND 2, MDB 2, Magic Burst Dmg+
...
--Sortie Earrings
gear.aminiEarring = hp_gear("Amini Earring", 0)                --Enmity -7, PDL 7
gear.aminiEarringPlusOne = hp_gear("Amini Earring +1", 0)      --Enmity -8, PDL 8
gear.aminiEarringPlusTwo = hp_gear("Amini Earring +2", 0)      --Enmity -9, PDL 9
gear.arbatelEarring = hp_gear("Arbatel Earring", 0)            --MAB 7, MDmg 7
gear.arbatelEarringPlusOne = hp_gear("Arbatel Earring +1", 0)  --MAB 8, MDmg 8
gear.arbatelEarringPlusTwo = hp_gear("Arbatel Earring +2", 0)  --MAB 9, MDmg 9
gear.azimuthEarring = hp_gear("Azimuth Earring", 0)            --MAB 7, Geomancy 10
gear.azimuthEarringPlusOne = hp_gear("Azimuth Earring +1", 0)  --MAB 8, Geomancy 11
gear.azimuthEarringPlusTwo = hp_gear("Azimuth Earring +2", 0)  --MAB 9, Geomancy 12
gear.beckonerEarring = hp_gear("Beck. Earring", 0)             --Refresh 1, Avatar Lv +1, Blood Pact 3
gear.beckonerEarringPlusTwo = hp_gear("Beck. Earring +2", 0)   --Refresh 3, Avatar Lv +1, Blood Pact 5
gear.bhikkuEarring = hp_gear("Bhikku Earring", 0)              --Hand Skill 10, Counter 7
gear.bhikkuEarringPlusOne = hp_gear("Bhikku Earring +1", 0)    --Hand Skill 11, Counter 8
gear.bhikkuEarringPlusTwo = hp_gear("Bhikku Earring +2", 0)    --Hand Skill 12, Counter 9
gear.boiiEarring = hp_gear("Boii Earring", 0)                  --DA 7, SB 5
gear.boiiEarringPlusTwo = hp_gear("Boii Earring +2", 0)        --DA 9, SB 7
gear.chasseurEarring = hp_gear("Chas. Earring", 0)             --Enmity -7, Recycle 10
gear.chasseurEarringPlusTwo = hp_gear("Chas. Earring +2", 0)   --Enmity -9, Recycle 12
gear.chevalierEarring = hp_gear("Chev. Earring", 0)            --DEF 20, Shield Skill 10, Cure Pot 10
gear.chevalierEarringPlusTwo = hp_gear("Chev. Earring +2", 0)  --DEF 25, Shield Skill 12, Cure Pot 12
gear.ebersEarring = hp_gear("Ebers Earring", 0)                --Healing magic Skill 10, Enmity -7
gear.ebersEarringPlusTwo = hp_gear("Ebers Earring +2", 0)      --Healing magic Skill 12, Enmity -9
gear.erilazEarring = hp_gear("Erilaz Earring", 0)              --Meva 10, Regen Rec 10
gear.erilazEarringPlusOne = hp_gear("Erilaz Earring +1", 0)    --Meva 11, Regen Rec 11
gear.erilazEarringPlusTwo = hp_gear("Erilaz Earring +2", 0)    --Meva 12, Regen Rec 12
gear.filiEarring = hp_gear("Fili Earring", 0)                  --Singing 10, Enmity -7
gear.filiEarringPlusOne = hp_gear("Fili Earring +1", 0)        --Singing 11, Enmity -8
gear.filiEarringPlusTwo = hp_gear("Fili Earring +2", 0)        --Singing 12, Enmity -9
gear.hashishinEarring = hp_gear("Hashishin Earring", 0)        --Sword Skill 10, Blue magic Skill 10
gear.hashishinEarringPlusTwo = hp_gear("Hashi. Earring +2", 0) --Sword Skill 12, Blue magic Skill 12
gear.hattoriEarring = hp_gear("Hattori Earring", 0)            --Katana Skill 10, Throwing Skill 10, PDL 7
gear.hattoriEarringPlusTwo = hp_gear("Hattori Earring +2", 0)  --Katana Skill 12, Throwing Skill 12, PDL 9
gear.heathenEarring = hp_gear("Heathen's Earring", 0)          --Att 15, PDL 7
gear.heathenEarringPlusOne = hp_gear("Heath. Earring +1", 0)   --Att 17, PDL 8
gear.heathenEarringPlusTwo = hp_gear("Heath. Earring +2", 0)   --Att 20, PDL 9
gear.karagozEarring = hp_gear("Karagoz Earring", 0)            --Hand Skill 10, SB 5, Automaton Lv +1
gear.karagozEarringPlusTwo = hp_gear("Kara. Earring +2", 0)    --Hand Skill 12, SB 7, Automaton Lv +1
gear.kasugaEarring = hp_gear("Kasuga Earring", 0)              --STP 7, SC Bonus 5
gear.kasugaEarringPlusTwo = hp_gear("Kasuga Earring +2", 0)    --STP 9, SC Bonus 7
gear.lethargyEarring = hp_gear("Lethargy Earring", 0)          --FC 7, Enhancing Dur 7
gear.lethargyEarringPlusTwo = hp_gear("Leth. Earring +2", 0)   --FC 9, Enhancing Dur 9
gear.maculeleEarring = hp_gear("Maculele Earring", 0)          --SC Bonus 5, PDL 7
gear.maculeleEarringPlusOne = hp_gear("Macu. Earring +1", 0)   --SC Bonus 6, PDL 8
gear.maculeleEarringPlusTwo = hp_gear("Macu. Earring +2", 0)   --SC Bonus 7, PDL 9
gear.nukumiEarring = hp_gear("Nukumi Earring", 0)              --Axe Skill 10, PDL 7, Pet Lv +1
gear.nukumiEarringPlusTwo = hp_gear("Nukumi Earring +2", 0)    --Axe Skill 12, PDL 9, Pet Lv +1
gear.peltastEarring = hp_gear("Peltast's Earring", 0)          --SB 5, PDL 7, Wyvern Lv +1
gear.peltastEarringPlusTwo = hp_gear("Pel. Earring +2", 0)     --SB 7, PDL 9, Wyvern Lv +1
gear.skulkerEarring = hp_gear("Skulker's Earring", 0)          --TA 3, SB 5
gear.skulkerEarringPlusTwo = hp_gear("Skulk. Earring +2", 0)   --TA 5, SB 7
gear.wicceEarring = hp_gear("Wicce Earring", 0)                --MAB 7, MDmg 7
gear.wicceEarringPlusTwo = hp_gear("Wicce Earring +2", 0)      --MAB 9, MDmg 9

--Ring
gear.adoulinRing = hp_gear("Adoulin Ring", 50)                --Acc 5, Att 15, Racc 5, Ratt 15, Macc 5, MAB 7, MP 50
gear.adoulinRingPlusOne = hp_gear("Adoulin Ring +1", 55)      --Acc 8, Att 20, Racc 8, Ratt 20, Macc 8, MAB 8, MP 55
...
gear.balrahnRing = hp_gear("Balrahn's Ring", 0)               --Macc 4, Assault: INT/MND/CHR 4, Refresh
...
gear.ducalGuardRing = hp_gear("Dcl.Grd. Ring", 0)             --Enchantment: Ducal Recall, 5 charges
gear.ephramadRing = hp_gear("Ephramad's Ring", 0)             --PDL 10, STR/DEX/AGI 10, Acc 20, Att 20, Racc 20, Ratt 20
...
gear.excelsisRing = hp_gear("Excelsis Ring", 0)               --Att 8, Drain/Aspir+
gear.fenrir = mp_gear("Fenrir Ring", 50)                      --Dark +15, MAB 2
gear.fickblixRing = hp_gear("Fickblix's Ring", 0)             --DA 10, SB 10, Pet Acc/Racc/Macc 20, Pet Dmg 10
...
gear.gelatinous = hp_gear("Gelatinous Ring", 35)              --Unity Ranking HP+10~35 at top rank; PDT 6, MDT +2
...
gear.griffonRing = hp_gear("Griffon Ring", 25)                --Reduces enemy crit rate
gear.gurebuRing = hp_gear("Gurebu's Ring", 0)                 --MND 10, MEva 20, All Status Res 20, Regen 2, Refresh 2
gear.havertonRing = hp_gear("Haverton Ring", 0)               --Racc 20, Ninjutsu Skill 10, Snapshot 6, DW 5
gear.havertonRingPlusOne = hp_gear("Haverton Ring +1", 0)     --Racc 23, Ninjutsu Skill 11, Snapshot 7, DW 6
...
gear.jalzahnRing = hp_gear("Jalzahn's Ring", 0)               --Racc 6, Ratt 6, Assault: AGI 6, Snapshot+
gear.jannistonRing = mp_gear("Janniston Ring", 40)            --Enmity -7, Cure Pot II 5, MP 40
gear.jannistonRingPlusOne = mp_gear("Jann. Ring +1", 44)      --Enmity -8, Cure Pot II 6, MP 44
gear.karieyh = hp_gear("Karieyh Ring", 0)                     --WSD 5, Regain 5
gear.kishar = hp_gear("Kishar Ring", 0)                       --FC 4, Macc 5, Enfeebling Dur 10
gear.ligeiaRing = hp_gear("Ligeia Ring", 0)                   --Resist Silence 7, Resist Slow 7, Silenced: Refresh 1
gear.luzaf = hp_gear("Luzaf's Ring", 0)                       --Phantom Roll Range 16
gear.medadaRing = hp_gear("Medada's Ring", 0)                 --INT 10, Macc 20, MAB 10, FC 10
...
gear.nesanicaRing = hp_gear("Nesanica Ring", 0)               --Resist Sleep 5, Sleeping: Regen 1, Regain 10
gear.niqmaddu = hp_gear("Niqmaddu Ring", 0)              --QA 3, SB II 5, STR/DEX/VIT 10
gear.orvailRing = hp_gear("Orvail Ring", 0)                   --Synthesis: Success 1, HQ 1, Material Loss 1, Skill Gain 5
gear.orvailRingPlusOne = hp_gear("Orvail Ring +1", 0)         --Synthesis: Success 2, HQ 1, Material Loss 2, Skill Gain 6
...
gear.rageliseRing = hp_gear("Ragelise's Ring", 0)             --DT 10, VIT 10, Cure Rec 10
gear.rajas = hp_gear("Rajas Ring", 0)                         --STP 5, SB 5
gear.renayeRing = hp_gear("Renaye Ring", 0)                   --Singing/Blue/Geomancy Skill 10, Refresh 1
gear.renayeRingPlusOne = hp_gear("Renaye Ring +1", 0)         --Singing/Blue/Geomancy Skill 11, Refresh 2
gear.sattvaRing = hp_gear("Sattva Ring", 15)                  --VIT 2-5, AGI 2-5, Enmity 3
gear.shneddickRingPlusOne = hp_gear("Shneddick Ring +1", 0)   --Movement 18%, Resist Petrify/Bind/Gravity 17
...
gear.tamasRing = mp_gear("Tamas Ring", 15)                    --INT 2-5, MND 2-5, Enmity -3, MP 15-30
gear.tavnazianRing = hp_gear("Tavnazian Ring", 0)             --Enchantment: Teleport (Tavnazian Safehold)
gear.thurandautRing = hp_gear("Thurandaut Ring", 0)           --Pet Acc/Racc 20, Pet Att/Ratt 20, Pet Haste 3, Pet DT 3
gear.thurandautRingPlusOne = hp_gear("Thur. Ring +1", 0)      --Pet Acc/Racc 22, Pet Att/Ratt 23, Pet Haste 4, Pet DT 4
gear.ulthalamRing = hp_gear("Ulthalam's Ring", 0)             --Acc 4, Att 4, Assault: STR/DEX 4, Regen
gear.vengeful = hp_gear("Vengeful Ring", 20)                  --HP swap for FC
gear.vertigo = hp_gear("Vertigo Ring", 0)                     --PDT 2, Macc 5, INT 5, MND 5
gear.vocaneRing = hp_gear("Vocane Ring", 0)                   --DT 7, Cure Rec 5, Knockback 2
gear.vocaneRingPlusOne = hp_gear("Vocane Ring +1", 0)         --DT 8, Cure Rec 6, Knockback 2
gear.weatherspoon = hp_gear("Weather. Ring", 0)               --FC 5, QM 3, Light MAB 10, Macc 10
gear.weatherspoonRingPlusOne = hp_gear("Weather. Ring +1", 0) --Macc 13, FC 6, Quick Magic 4, Light MAB 11
gear.woltarisRing = hp_gear("Woltaris Ring", 0)               --Sublimation 1, Regen 1, Refresh 1
gear.woltarisRingPlusOne = hp_gear("Woltaris Ring +1", 0)     --Sublimation 2, Regen 2, Refresh 2
gear.zodiacRing = mp_gear("Zodiac Ring", 25)                  --Day-based Elemental Magic+, MP 25
...
gear.stikiniRingPlusOne4 = hp_gear("Stikini Ring +1", 0, { bag = "wardrobe4" }) --Refresh 1, Macc 11
gear.stikiniRingPlusOne5 = hp_gear("Stikini Ring +1", 0, { bag = "wardrobe5" }) --Refresh 1, Macc 11
gear.stikiniRingPlusOne6 = hp_gear("Stikini Ring +1", 0, { bag = "wardrobe6" }) --Refresh 1, Macc 11
gear.stikiniRingPlusOne7 = hp_gear("Stikini Ring +1", 0, { bag = "wardrobe7" }) --Refresh 1, Macc 11
gear.stikiniRingPlusOne8 = hp_gear("Stikini Ring +1", 0, { bag = "wardrobe8" }) --Refresh 1, Macc 11
...
gear.fenrirRingPlusOne1 = mp_gear("Fenrir Ring +1", 50, { bag = "wardrobe" })  --Dark +15, MAB 2
gear.fenrirRingPlusOne2 = mp_gear("Fenrir Ring +1", 50, { bag = "wardrobe2" }) --Dark +15, MAB 2
gear.fenrirRingPlusOne3 = mp_gear("Fenrir Ring +1", 50, { bag = "wardrobe3" }) --Dark +15, MAB 2
gear.fenrirRingPlusOne4 = mp_gear("Fenrir Ring +1", 50, { bag = "wardrobe4" }) --Dark +15, MAB 2
gear.fenrirRingPlusOne5 = mp_gear("Fenrir Ring +1", 50, { bag = "wardrobe5" }) --Dark +15, MAB 2
gear.fenrirRingPlusOne6 = mp_gear("Fenrir Ring +1", 50, { bag = "wardrobe6" }) --Dark +15, MAB 2
gear.fenrirRingPlusOne7 = mp_gear("Fenrir Ring +1", 50, { bag = "wardrobe7" }) --Dark +15, MAB 2
gear.fenrirRingPlusOne8 = mp_gear("Fenrir Ring +1", 50, { bag = "wardrobe8" }) --Dark +15, MAB 2
...
--Back
gear.aesirMantle = hp_gear("Aesir Mantle", 0)          --Att 8, DA 1, Darksday DA 2
...
gear.gorneyRing = hp_gear("Gorney Ring", 0)           --TH 1, Gilfinder 1, Steal 2, Mug 1
gear.gorneyRingPlusOne = hp_gear("Gorney Ring +1", 0) --TH 1, Gilfinder 2, Steal 3, Mug 2
...
gear.despairBodyPathD = hp_gear("Despair Mail", 121, {
    augments = { 'Attack+25', 'Mag. Evasion+20', '"Dbl.Atk."+3' }, })
...
gear.despairHandsPathD = hp_gear("Despair Fin. Gaunt.", 57, {
    augments = { 'Rng.Acc.+25', 'Rng.Atk.+20', '"Recycle"+10' }, })
...
gear.eschiteHandsPathD = hp_gear("Eschite Gauntlets", 29, {
    augments = { 'Accuracy+20', '"Dbl.Atk."+4', 'Enmity+7' }, })                    --Enmity 7, Acc 20
...
gear.nagaHeadPathD = hp_gear("Naga Somen", 86, {
    augments = { 'Accuracy+15', 'Rng.Acc.+25', 'Enmity-6' }, })                 --Enmity -6, Acc 15
...
gear.nagaLegsPathD = hp_gear("Naga Hakama", 97, {
    augments = { 'Attack+20', 'Rng.Atk.+25', 'Crit.hit rate +4%' }, })
...
gear.pursuerHeadPathD = hp_gear("Pursuer's Beret", 36, {
    augments = { 'Rng.Atk.+15', 'Enmity-6', '"Subtle Blow"+7' }, }) --Enmity -6
...
gear.pursuerBodyPathD = hp_gear("Pursuer's Doublet", 159, {
    augments = { 'HP+50', 'Crit.hit rate +4%', '"Snapshot"+6' }, }) --HP 50, Snapshot 6
...
gear.pursuerHandsPathD = hp_gear("Pursuer's Cuffs", 25, {
    augments = { 'Rng.Atk.+15', 'STR+7', 'Phys. dmg. taken -4%' }, }) --PDT 4
...
gear.rawhideBodyPathD = hp_gear("Rawhide Vest", 109, {
    augments = { 'HP+50', '"Subtle Blow"+7', '"Triple Atk."+2', }, })         --HP 50, Subtle Blow 7, Triple Atk. 2
...
gear.vanyaHandsPathD = hp_gear("Vanya Cuffs", 22, {
    augments = { 'CHR+10', 'String instrument skill +10', 'Mag. Acc.+20' }, }) --Macc 20
...
gear.apogeeHandsPathD = hp_gear("Apogee Mitts", -80, {
    augments = { 'Pet: Mag. Acc.+20', 'Blood Pact Dmg.+7' }, })                                   --BP Dmg 7, Macc 20; Blood Pact ab. del. -5 left out: the decoder carries two delay encodings and which one this item uses has not been read from an item; these two identify the path
...
gear.argosyHeadPathD = hp_gear("Argosy Celata", 50, {
    augments = { 'DEX+10', 'Accuracy+15', '"Dbl.Atk."+2' }, }) --Acc 15
...
gear.argosyHandsPathD = hp_gear("Argosy Mufflers", 34, {
    augments = { 'STR+15', '"Dbl.Atk."+2', 'Haste+2%' }, })
...
gear.argosyFeetPathD = hp_gear("Argosy Sollerets", 82, {
    augments = { 'HP+60', '"Dbl.Atk."+2', '"Store TP"+3' }, }) --HP 60, STP 3
...
gear.carmineBodyPathD = hp_gear("Carm. Scale Mail", 91, {
    augments = { 'Attack+15', '"Mag.Atk.Bns."+10', '"Dbl.Atk."+2' }, }) --MAB 10
...
gear.carmineHandsPathD = hp_gear("Carmine Fin. Ga.", 27, {
    augments = { 'Rng.Atk.+15', '"Mag.Atk.Bns."+10', '"Store TP"+5' }, })  --STP 5, MAB 10
...
gear.lustratioHeadPathA = hp_gear("Lustratio Cap", 22, {
    augments = { 'Attack+15', 'STR+5', '"Dbl.Atk."+2' }, })
gear.lustratioHeadPathB = hp_gear("Lustratio Cap", 22, {
    augments = { 'Accuracy+15', 'DEX+5', 'Crit.hit rate +2%' }, }) --Acc 15
...
gear.lustratioBodyPathD = hp_gear("Lustratio Harness", 34, {
    augments = { 'Accuracy+8', 'Attack+10', '"Dbl.Atk."+2' }, }) --Acc 8
...
gear.raoLegsPathD = hp_gear("Rao Haidate", 0, {
    augments = { 'Accuracy+20', '"Dbl.Atk."+3', 'Pet: Accuracy+20' }, })    --Acc 20
...
gear.raoFeetPathD = hp_gear("Rao Sune-Ate", 50, {
    augments = { 'HP+50', 'Crit.hit rate +3%', '"Dbl.Atk."+2' }, })     --HP 50
...
gear.ryuoBodyPathD = hp_gear("Ryuo Domaru", 213, {
    augments = { 'HP+50', '"Store TP"+5', '"Dbl.Atk."+2' }, })             --HP 50, STP 5
...
gear.ryuoHandsPathD = hp_gear("Ryuo Tekko", 29, {
    augments = { 'DEX+10', 'Accuracy+20', '"Dbl.Atk."+3' }, })             --Acc 20
...
gear.ryuoFeetPathD = hp_gear("Ryuo Sune-Ate", 18, {
    augments = { 'STR+10', 'Attack+20', 'Crit.hit rate +3%' }, })
...
gear.souveranHandsPathC = hp_gear("Souv. Handschuhs", 164, {
    augments = { 'HP+80', 'Enmity+7', 'Potency of "Cure" effect received +10%' }, }) --HP 80, Enmity 7
gear.souveranHandsPathD = hp_gear("Souv. Handschuhs", 134, {
    augments = { 'HP+50', 'Shield skill +10', 'Phys. dmg. taken -3', }, })            --HP 50, PDT 3, Shield Skill 10
...
gear.apogeeHandsPlusOnePathD = hp_gear("Apogee Mitts +1", -90, {
    augments = { 'Pet: Mag. Acc.+25', 'Blood Pact Dmg.+8' }, })                                   --BP Dmg 8, Macc 25; Blood Pact ab. del. -7 left out: the decoder carries two delay encodings and which one this item uses has not been read from an item; these two identify the path
...
gear.argosyHeadPlusOnePathD = hp_gear("Argosy Celata +1", 50, {
    augments = { 'DEX+12', 'Accuracy+20', '"Dbl.Atk."+3' }, }) --Acc 20
...
gear.argosyFeetPlusOnePathD = hp_gear("Argosy Sollerets +1", 87, {
    augments = { 'HP+65', '"Dbl.Atk."+3', '"Store TP"+5' }, }) --HP 65, STP 5
...
gear.carmineBodyPlusOnePathD = hp_gear("Carm. Sc. Mail +1", 96, {
    augments = { '"Mag.Atk.Bns."+12', 'Attack+20', '"Dbl.Atk."+4' }, }) --MAB 12
...
gear.lustratioHeadPlusOnePathB = hp_gear("Lustratio Cap +1", 23, {
    augments = { 'Accuracy+20', 'DEX+8', 'Crit.hit rate +3%' }, }) --Acc 20
...
gear.lustratioBodyPlusOnePathD = hp_gear("Lustr. Harness +1", 35, {
    augments = { 'Accuracy+10', 'Attack+13', '"Dbl.Atk."+4' }, }) --Acc 10
...
gear.raoLegsPlusOnePathD = hp_gear("Rao Haidate +1", 0, {
    augments = { 'Accuracy+25', '"Dbl.Atk."+4', 'Pet: Accuracy+25' }, })    --Acc 25
...
gear.raoFeetPlusOnePathD = hp_gear("Rao Sune-Ate +1", 65, {
    augments = { 'HP+65', 'Crit.hit rate +4%', '"Dbl.Atk."+4' }, })     --HP 65
...
gear.ryuoBodyPlusOnePathD = hp_gear("Ryuo Domaru +1", 233, {
    augments = { 'HP+65', '"Store TP"+8', '"Dbl.Atk."+4' }, })             --HP 65, STP 8
...
gear.ryuoHandsPlusOnePathD = hp_gear("Ryuo Tekko +1", 29, {
    augments = { 'DEX+12', 'Accuracy+25', '"Dbl.Atk."+4' }, })             --Acc 25
...
gear.ryuoFeetPlusOnePathD = hp_gear("Ryuo Sune-Ate +1", 18, {
    augments = { 'STR+12', 'Attack+25', 'Crit.hit rate +4%' }, })
...
gear.mijinPathA = rank_gear("Mijin", 100, {
    augments = { 'Attack+15', 'Accuracy+15', 'Rng.Acc.+15', }, })
gear.mijinPathB = rank_gear("Mijin", 100, {
    augments = { 'Accuracy+15', 'Rng.Acc.+15', '"Store TP"+5', }, })
gear.mijinPathC = rank_gear("Mijin", 100, {
    augments = { 'INT+7', 'Mag. Acc.+15', '"Mag.Atk.Bns."+15', }, })
gear.mijinPathD = rank_gear("Mijin", 100, {
    augments = { 'Evasion+20', 'Mag. Evasion+20', 'Enmity+4', }, })
gear.nibiruBladePathA = rank_gear("Nibiru Blade", 100, {
    augments = { 'DEX+10', 'Accuracy+20', 'Mag. Acc.+15', }, })
gear.nibiruBladePathB = rank_gear("Nibiru Blade", 100, {
    augments = { 'STR+10', 'Attack+20', '"Store TP"+3', }, })
gear.nibiruBladePathC = rank_gear("Nibiru Blade", 100, {
    augments = { 'Mag. Acc.+15', '"Mag.Atk.Bns."+15', 'Mag. Evasion+20', }, })
gear.nibiruBladePathD = rank_gear("Nibiru Blade", 100, {
    augments = { 'HP+50', '"Dbl.Atk."+3', '"Fast Cast"+5', }, })
gear.nibiruBowPathA = hp_gear("Nibiru Bow", 0, {
    augments = { 'AGI+10', 'Rng.Acc.+25', 'Enmity-6', }, })
gear.nibiruBowPathB = hp_gear("Nibiru Bow", 50, {
    augments = { 'HP+50', 'Rng.Atk.+25', '"Rapid Shot"+10', }, })
gear.nibiruBowPathC = hp_gear("Nibiru Bow", 0, {
    augments = { 'AGI+10', 'Rng.Acc.+15', 'Rng.Atk.+15', }, })
gear.nibiruBowPathD = hp_gear("Nibiru Bow", 0, {
    augments = { 'Rng.Atk.+20', '"Recycle"+15', '"Store TP"+5', }, })
gear.nibiruChopperPathA = rank_gear("Nibiru Chopper", 100, {
    augments = { 'HP+50', 'STR+10', 'Accuracy+25', }, })
gear.nibiruChopperPathB = rank_gear("Nibiru Chopper", 100, {
    augments = { 'Attack+20', 'Enmity+4', '"Dbl.Atk."+3', }, })
gear.nibiruChopperPathC = rank_gear("Nibiru Chopper", 100, {
    augments = { 'VIT+10', 'Evasion+20', 'Counter+3', }, })
gear.nibiruChopperPathD = rank_gear("Nibiru Chopper", 100, {
    augments = { 'HP+80', 'Enmity+7', 'Phys. dmg. taken -3%', }, })
gear.nibiruCudgelPathA = rank_gear("Nibiru Cudgel", 100, {
    augments = { 'MND+10', 'Mag. Acc.+15', '"Cure" potency +15%', }, })
gear.nibiruCudgelPathB = rank_gear("Nibiru Cudgel", 100, {
    augments = { 'MP+50', 'INT+10', '"Mag.Atk.Bns."+15', }, })
gear.nibiruCudgelPathC = rank_gear("Nibiru Cudgel", 100, {
    augments = { 'Accuracy+15', 'Mag. Acc.+15', '"Fast Cast"+3', }, })
gear.nibiruCudgelPathD = rank_gear("Nibiru Cudgel", 100, {
    augments = { 'MP+50', 'Pet: Damage taken -3%', 'Pet: "Regen"+2', }, })
gear.nibiruFaussarPathA = rank_gear("Nibiru Faussar", 100, {
    augments = { 'STR+10', 'Attack+25', 'Mag. Acc.+15', }, })
gear.nibiruFaussarPathB = rank_gear("Nibiru Faussar", 100, {
    augments = { 'Accuracy+10', 'Attack+15', '"Store TP"+5', }, })
gear.nibiruFaussarPathC = rank_gear("Nibiru Faussar", 100, {
    augments = { 'Evasion+20', 'Mag. Evasion+20', '"Fast Cast"+5', }, })
gear.nibiruFaussarPathD = rank_gear("Nibiru Faussar", 100, {
    augments = { 'VIT+10', 'Accuracy+25', 'Phys. dmg. taken -4%', }, })
gear.nibiruGunPathA = hp_gear("Nibiru Gun", 0, {
    augments = { 'STR+10', 'Rng.Acc.+15', '"Store TP"+3', }, })
gear.nibiruGunPathB = hp_gear("Nibiru Gun", 50, {
    augments = { 'HP+50', 'AGI+10', 'Rng.Acc.+20', }, })
gear.nibiruGunPathC = hp_gear("Nibiru Gun", 0, {
    augments = { 'STR+10', 'Rng.Acc.+15', 'Rng.Atk.+15', }, })
gear.nibiruGunPathD = hp_gear("Nibiru Gun", 0, {
    augments = { 'STR+15', 'AGI+7', '"Store TP"+5', }, })
gear.nibiruHarpPathA = hp_gear("Nibiru Harp", 0, {
    augments = { 'MP+50', 'Mag. Acc.+10', 'All songs +2', }, })
gear.nibiruHarpPathB = hp_gear("Nibiru Harp", 50, {
    augments = { 'HP+50', 'CHR+10', 'All songs +2', }, })
gear.nibiruHarpPathC = hp_gear("Nibiru Harp", 0, {
    augments = { 'MP+50', '"Cure" potency +5%', 'All songs +2', }, })
gear.nibiruHarpPathD = hp_gear("Nibiru Harp", 0, {
    augments = { 'Mag. Evasion+20', 'Phys. dmg. taken -3%', 'Magic dmg. taken -3%', }, })
gear.nibiruKnifePathA = rank_gear("Nibiru Knife", 100, {
    augments = { 'Accuracy+20', 'Attack+15', 'Evasion+20', }, })
gear.nibiruKnifePathB = rank_gear("Nibiru Knife", 100, {
    augments = { 'DEX+7', 'Attack+20', '"Store TP"+3', }, })
gear.nibiruKnifePathC = rank_gear("Nibiru Knife", 100, {
    augments = { 'STR+15', 'DEX+10', 'CHR+10', }, })
gear.nibiruKnifePathD = rank_gear("Nibiru Knife", 100, {
    augments = { 'MP+50', 'Mag. Evasion+20', '"Fast Cast"+5', }, })
gear.nibiruLancePathA = rank_gear("Nibiru Lance", 100, {
    augments = { 'STR+10', 'Accuracy+20', '"Dbl.Atk."+3', }, })
gear.nibiruLancePathB = rank_gear("Nibiru Lance", 100, {
    augments = { 'HP+50', 'Accuracy+15', 'Attack+15', }, })
gear.nibiruLancePathC = rank_gear("Nibiru Lance", 100, {
    augments = { 'Pet: HP+100', 'Pet: Accuracy+20', 'Pet: Attack+20', }, })
gear.nibiruLancePathD = rank_gear("Nibiru Lance", 100, {
    augments = { 'Accuracy+20', 'Pet: Accuracy+20', '"Store TP"+5', }, })
gear.nibiruSaintiPathA = rank_gear("Nibiru Sainti", 100, {
    augments = { 'Accuracy+25', 'STR+7', '"Subtle Blow"+7', }, })
gear.nibiruSaintiPathB = rank_gear("Nibiru Sainti", 100, {
    augments = { 'HP+50', 'Attack+20', '"Store TP"+3', }, })
gear.nibiruSaintiPathC = rank_gear("Nibiru Sainti", 100, {
    augments = { 'Evasion+20', 'Enmity+7', 'Phys. dmg. taken -3%', }, })
gear.nibiruSaintiPathD = rank_gear("Nibiru Sainti", 100, {
    augments = { 'Melee skill +20', 'Ranged skill +20', 'Magic skill +20', }, })
gear.nibiruShieldPathA = hp_gear("Nibiru Shield", 80, {
    augments = { 'HP+80', 'Enmity+7', 'Phys. dmg. taken -5%', }, })
gear.nibiruShieldPathB = hp_gear("Nibiru Shield", 80, {
    augments = { 'HP+80', 'MP+80', '"Fast Cast"+7', }, })
gear.nibiruShieldPathC = hp_gear("Nibiru Shield", 0, {
    augments = { 'MND+15', '"Cure" potency +5%', 'Potency of "Cure" effect received +5%', }, })
gear.nibiruShieldPathD = hp_gear("Nibiru Shield", 0, {
    augments = { 'Accuracy+15', 'Attack+15', '"Store TP"+5', }, })
gear.nibiruSicklePathA = rank_gear("Nibiru Sickle", 100, {
    augments = { 'STR+10', 'Attack+25', 'INT+7', }, })
gear.nibiruSicklePathB = rank_gear("Nibiru Sickle", 100, {
    augments = { 'Attack+20', '"Mag.Atk.Bns."+25', '"Fast Cast"+5', }, })
gear.nibiruSicklePathC = rank_gear("Nibiru Sickle", 100, {
    augments = { 'Accuracy+20', 'Attack+15', '"Store TP"+3', }, })
gear.nibiruSicklePathD = rank_gear("Nibiru Sickle", 100, {
    augments = { 'Mag. Acc.+20', '"Mag.Atk.Bns."+15', 'Refresh+1', }, })
gear.nibiruStaffPathA = rank_gear("Nibiru Staff", 100, {
    augments = { 'MP+80', '"Mag.Atk.Bns."+25', 'Enmity-5', }, })
gear.nibiruStaffPathB = rank_gear("Nibiru Staff", 100, {
    augments = { 'Magic dmg. taken -3%', 'MND+10', 'Mag. Acc.+25', }, })
gear.nibiruStaffPathC = rank_gear("Nibiru Staff", 100, {
    augments = { 'Pet: "Regen"+2', 'Pet: Mag. Acc.+20', 'Pet: "Mag.Atk.Bns."+25', }, })
gear.nibiruStaffPathD = rank_gear("Nibiru Staff", 100, {
    augments = { 'Pet: Accuracy+20', 'Pet: Attack+20', 'Pet: "Dbl.Atk."+3', }, })
gear.nibiruTabarPathA = rank_gear("Nibiru Tabar", 100, {
    augments = { 'STR+10', 'Attack+20', 'Pet: Attack+20', }, })
gear.nibiruTabarPathB = rank_gear("Nibiru Tabar", 100, {
    augments = { 'Accuracy+15', 'Attack+15', '"Store TP"+5', }, })
gear.nibiruTabarPathC = rank_gear("Nibiru Tabar", 100, {
    augments = { 'Pet: Attack+25', 'Pet: "Mag.Atk.Bns."+15', 'Pet: Enmity+7', }, })
gear.nibiruTabarPathD = rank_gear("Nibiru Tabar", 100, {
    augments = { 'CHR+15', 'Pet: Haste+3', 'Pet: "Dbl.Atk."+3', }, })
gear.sensuiPathA = rank_gear("Sensui", 100, {
    augments = { 'DEX+7', 'Accuracy+20', '"Store TP"+5', }, })
gear.sensuiPathB = rank_gear("Sensui", 100, {
    augments = { 'Attack+15', '"Subtle Blow"+7', '"Dbl.Atk."+3', }, })
gear.sensuiPathC = rank_gear("Sensui", 100, {
    augments = { 'AGI+10', 'Rng.Acc.+15', 'Rng.Atk.+20', }, })
gear.sensuiPathD = rank_gear("Sensui", 100, {
    augments = { 'Evasion+20', 'Mag. Evasion+20', 'Phys. dmg. taken -3%', }, })
--Escha - Ru'Aun
gear.aizushintogoPathA = rank_gear("Aizushintogo", 100, {
    augments = { 'DMG:+15', 'STR+15', 'Attack+15', }, })
gear.aizushintogoPathB = rank_gear("Aizushintogo", 100, {
    augments = { 'DMG:+15', 'STR+15', 'Accuracy+10', }, })
gear.aizushintogoPathC = rank_gear("Aizushintogo", 100, {
    augments = { 'DMG:+15', 'Accuracy+15', 'Attack+15', }, })
gear.aizushintogoPathD = rank_gear("Aizushintogo", 100, {
    augments = { 'DMG:+17', 'Accuracy+15', 'Rng.Acc.+15', }, })
gear.akademosPathA = rank_gear("Akademos", 100, {
    augments = { 'MP+80', 'INT+20', '"Mag.Atk.Bns."+20', }, })
gear.akademosPathB = rank_gear("Akademos", 100, {
    augments = { 'MND+20', 'Mag. Acc.+20', '"Cure" potency +10%', }, })
gear.akademosPathC = rank_gear("Akademos", 100, {
    augments = { 'INT+15', '"Mag.Atk.Bns."+15', 'Mag. Acc.+15', }, })
gear.akademosPathD = rank_gear("Akademos", 100, {
    augments = { 'Mag. Acc.+20', 'Enha.mag. skill +15', 'Enfb.mag. skill +15', }, })
gear.bidenhanderPathA = rank_gear("Bidenhander", 100, {
    augments = { 'DMG:+30', 'STR+20', 'Attack+20', }, })
gear.bidenhanderPathB = rank_gear("Bidenhander", 100, {
    augments = { 'DMG:+30', 'Accuracy+20', 'Attack+20', }, })
gear.bidenhanderPathC = rank_gear("Bidenhander", 100, {
    augments = { 'DMG:+30', 'Attack+20', 'Enmity+7', }, })
gear.bidenhanderPathD = rank_gear("Bidenhander", 100, {
    augments = { 'DMG:+32', '"Store TP"+7', 'Enmity+7', }, })
gear.compensatorPathA = hp_gear("Compensator", 0, {
    augments = { 'DMG:+15', 'AGI+15', 'Rng.Atk.+15', }, })
gear.compensatorPathB = hp_gear("Compensator", 0, {
    augments = { 'DMG:+15', 'AGI+15', 'Rng.Acc.+15', }, })
gear.compensatorPathC = hp_gear("Compensator", 0, {
    augments = { 'DMG:+15', 'Rng.Acc.+15', 'Rng.Atk.+15', }, })
gear.compensatorPathD = hp_gear("Compensator", 0, {
    augments = { 'DMG:+15', 'Rng.Atk.+15', '"Mag.Atk.Bns."+15', }, })
gear.deathbanePathA = rank_gear("Deathbane", 100, {
    augments = { 'DMG:+30', 'STR+20', 'Attack+20', }, })
gear.deathbanePathB = rank_gear("Deathbane", 100, {
    augments = { 'DMG:+30', 'Attack+20', '"Store TP"+3', }, })
gear.deathbanePathC = rank_gear("Deathbane", 100, {
    augments = { 'DMG:+30', 'Attack+20', 'Dark magic skill +15', }, })
gear.deathbanePathD = rank_gear("Deathbane", 100, {
    augments = { 'DMG:+32', 'MP+80', 'STR+20', }, })
gear.emissaryPathA = rank_gear("Emissary", 100, {
    augments = { 'DMG:+15', 'Accuracy+15', 'Attack+15', }, })
gear.emissaryPathB = rank_gear("Emissary", 100, {
    augments = { 'DMG:+15', 'Accuracy+15', 'Mag. Acc.+15', }, })
gear.emissaryPathC = rank_gear("Emissary", 100, {
    augments = { 'DMG:+15', 'Mag. Acc.+15', '"Mag.Atk.Bns."+15', }, })
gear.emissaryPathD = rank_gear("Emissary", 100, {
    augments = { 'Mag. Acc.+15', '"Mag.Atk.Bns."+20', 'Refresh+1', }, })
gear.enchuflaPathA = rank_gear("Enchufla", 100, {
    augments = { 'DMG:+15', 'STR+15', 'Attack+15', }, })
gear.enchuflaPathB = rank_gear("Enchufla", 100, {
    augments = { 'DMG:+15', 'STR+15', 'Accuracy+10', }, })
gear.enchuflaPathC = rank_gear("Enchufla", 100, {
    augments = { 'DMG:+15', 'DEX+15', '"Subtle Blow"+7', }, })
gear.enchuflaPathD = rank_gear("Enchufla", 100, {
    augments = { 'DMG:+17', 'Evasion+15', 'Mag. Evasion+15', }, })
gear.espiritusPathA = rank_gear("Espiritus", 100, {
    augments = { 'Enmity-6', 'Pet: "Mag.Atk.Bns."+30', 'Pet: Damage taken -4%', }, })
gear.espiritusPathB = rank_gear("Espiritus", 100, {
    augments = { 'Summoning magic skill +15', 'Pet: Mag. Acc.+30', 'Pet: Damage taken -4%', }, })
gear.espiritusPathC = rank_gear("Espiritus", 100, {
    augments = { 'MP+50', 'Pet: "Mag.Atk.Bns."+20', 'Pet: Mag. Acc.+20', }, })
gear.espiritusPathD = rank_gear("Espiritus", 100, {
    augments = { 'Pet: STR+15', 'Pet: Attack+25', 'Pet: "Dbl.Atk."+4', }, })
gear.hammerfistsPathA = rank_gear("Hammerfists", 100, {
    augments = { 'DMG:+15', 'STR+20', 'Attack+20', }, })
gear.hammerfistsPathB = rank_gear("Hammerfists", 100, {
    augments = { 'DMG:+15', 'STR+20', 'Accuracy+15', }, })
gear.hammerfistsPathC = rank_gear("Hammerfists", 100, {
    augments = { 'DMG:+15', 'Attack+20', 'Enmity-5', }, })
gear.hammerfistsPathD = rank_gear("Hammerfists", 100, {
    augments = { 'DMG:+17', 'HP+80', 'VIT+15', }, })
gear.ichigohitofuriPathA = rank_gear("Ichigohitofuri", 100, {
    augments = { 'DMG:+30', 'STR+20', 'Attack+20', }, })
gear.ichigohitofuriPathB = rank_gear("Ichigohitofuri", 100, {
    augments = { 'DMG:+30', 'STR+20', 'Accuracy+15', }, })
gear.ichigohitofuriPathC = rank_gear("Ichigohitofuri", 100, {
    augments = { 'DMG:+30', 'Attack+20', 'Accuracy+20', }, })
gear.ichigohitofuriPathD = rank_gear("Ichigohitofuri", 100, {
    augments = { 'AGI+20', 'Rng.Acc.+25', '"Recycle"+15', }, })
gear.instigatorPathA = rank_gear("Instigator", 100, {
    augments = { 'DMG:+30', 'STR+20', 'Attack+20', }, })
gear.instigatorPathB = rank_gear("Instigator", 100, {
    augments = { 'DMG:+30', 'STR+20', 'Accuracy+15', }, })
gear.instigatorPathC = rank_gear("Instigator", 100, {
    augments = { 'DMG:+30', 'Attack+20', 'Accuracy+20', }, })
gear.instigatorPathD = rank_gear("Instigator", 100, {
    augments = { 'DMG:+32', 'STR+15', 'VIT+15', }, })
gear.irisPathA = rank_gear("Iris", 100, {
    augments = { 'DMG:+15', 'STR+15', 'Attack+15', }, })
gear.irisPathB = rank_gear("Iris", 100, {
    augments = { 'DMG:+15', 'STR+15', 'Accuracy+15', }, })
gear.irisPathC = rank_gear("Iris", 100, {
    augments = { 'DMG:+15', 'Attack+15', '"Mag.Atk.Bns."+15', }, })
gear.irisPathD = rank_gear("Iris", 100, {
    augments = { 'Blue magic skill +15', 'Mag. Acc.+15', '"Mag.Atk.Bns."+15', }, })
gear.kaliPathA = rank_gear("Kali", 100, {
    augments = { 'DMG:+15', 'CHR+15', 'Mag. Acc.+15', }, })
gear.kaliPathB = rank_gear("Kali", 100, {
    augments = { 'DMG:+15', 'CHR+15', 'Enmity-5', }, })
gear.kaliPathC = rank_gear("Kali", 100, {
    augments = { 'MP+60', 'Mag. Acc.+20', 'Refresh+1', }, })
gear.kaliPathD = rank_gear("Kali", 100, {
    augments = { 'Mag. Acc.+15', 'String instrument skill +10', 'Wind instrument skill +10', }, })
gear.lathiPathA = rank_gear("Lathi", 100, {
    augments = { 'MP+80', 'INT+20', '"Mag.Atk.Bns."+20', }, })
gear.lathiPathB = rank_gear("Lathi", 100, {
    augments = { 'MP+80', 'Mag. Acc.+20', '"Fast Cast"+5', }, })
gear.lathiPathC = rank_gear("Lathi", 100, {
    augments = { 'INT+15', '"Mag.Atk.Bns."+15', 'Mag. Acc.+15', }, })
gear.lathiPathD = rank_gear("Lathi", 100, {
    augments = { 'Mag. Acc.+20', 'Enfb.mag. skill +15', 'Dark magic skill +15', }, })
gear.midnightsPathA = rank_gear("Midnights", 100, {
    augments = { 'DMG:+15', 'STR+20', 'Attack+20', }, })
gear.midnightsPathB = rank_gear("Midnights", 100, {
    augments = { 'DMG:+15', 'STR+20', 'Accuracy+20', }, })
gear.midnightsPathC = rank_gear("Midnights", 100, {
    augments = { 'DMG:+15', 'Pet: Attack+25', 'Pet: Haste+3', }, })
gear.midnightsPathD = rank_gear("Midnights", 100, {
    augments = { 'Pet: Attack+25', 'Pet: Accuracy+25', 'Pet: Damage taken -3%', }, })
gear.nixxerPathA = rank_gear("Nixxer", 100, {
    augments = { 'DMG:+15', 'STR+15', 'Attack+15', }, })
gear.nixxerPathB = rank_gear("Nixxer", 100, {
    augments = { 'DMG:+15', 'STR+15', 'Accuracy+10', }, })
gear.nixxerPathC = rank_gear("Nixxer", 100, {
    augments = { 'DMG:+15', 'Accuracy+15', 'Attack+15', }, })
gear.nixxerPathD = rank_gear("Nixxer", 100, {
    augments = { 'DMG:+17', 'STR+15', 'VIT+15', }, })
gear.quellerRodPathA = rank_gear("Queller Rod", 100, {
    augments = { 'MP+80', '"Cure" potency +15%', 'Enmity-5', }, })
gear.quellerRodPathB = rank_gear("Queller Rod", 100, {
    augments = { 'MND+15', 'Mag. Acc.+15', '"Cure" potency +15%', }, })
gear.quellerRodPathC = rank_gear("Queller Rod", 100, {
    augments = { '"Mag.Atk.Bns."+15', 'Mag. Acc.+15', '"Cure" potency +15%', }, })
gear.quellerRodPathD = rank_gear("Queller Rod", 100, {
    augments = { 'Healing magic skill +15', '"Cure" potency +10%', '"Cure" spellcasting time -7%', }, })
gear.rhomphaiaPathA = rank_gear("Rhomphaia", 100, {
    augments = { 'DMG:+30', 'STR+20', 'Attack+20', }, })
gear.rhomphaiaPathB = rank_gear("Rhomphaia", 100, {
    augments = { 'DMG:+30', 'STR+20', 'Accuracy+15', }, })
gear.rhomphaiaPathC = rank_gear("Rhomphaia", 100, {
    augments = { 'DMG:+30', 'VIT+15', 'Attack+20', }, })
gear.rhomphaiaPathD = rank_gear("Rhomphaia", 100, {
    augments = { 'DMG:+32', 'Attack+20', 'Enmity-5', }, })
gear.shijoPathA = rank_gear("Shijo", 100, {
    augments = { 'DMG:+15', 'STR+15', 'Attack+15', }, })
gear.shijoPathB = rank_gear("Shijo", 100, {
    augments = { 'DMG:+15', 'STR+15', 'Accuracy+10', }, })
gear.shijoPathC = rank_gear("Shijo", 100, {
    augments = { 'DMG:+15', 'Accuracy+15', 'Attack+15', }, })
gear.shijoPathD = rank_gear("Shijo", 100, {
    augments = { '"Dual Wield"+5', 'DEX+15', '"Triple Atk."+2', }, })
gear.skullrenderPathA = rank_gear("Skullrender", 100, {
    augments = { 'DMG:+15', 'STR+15', 'Attack+15', }, })
gear.skullrenderPathB = rank_gear("Skullrender", 100, {
    augments = { 'DMG:+15', 'STR+15', 'Accuracy+15', }, })
gear.skullrenderPathC = rank_gear("Skullrender", 100, {
    augments = { 'DMG:+15', 'Pet: Accuracy+20', 'Pet: Attack+20', }, })
gear.skullrenderPathD = rank_gear("Skullrender", 100, {
    augments = { 'DMG:+15', 'Pet: "Mag.Atk.Bns."+15', 'Pet: "Regen"+2', }, })
gear.solsticePathA = rank_gear("Solstice", 100, {
    augments = { 'MP+60', 'INT+15', '"Mag.Atk.Bns."+15', }, })
gear.solsticePathB = rank_gear("Solstice", 100, {
    augments = { 'MP+60', 'INT+15', 'Mag. Acc.+15', }, })
gear.solsticePathC = rank_gear("Solstice", 100, {
    augments = { 'INT+15', '"Mag.Atk.Bns."+10', 'Refresh+1', }, })
gear.solsticePathD = rank_gear("Solstice", 100, {
    augments = { 'Mag. Acc.+20', 'Pet: Damage taken -4%', '"Fast Cast"+5', }, })
gear.vijayaBowPathA = hp_gear("Vijaya Bow", 0, {
    augments = { 'DMG:+15', 'AGI+15', 'Rng.Atk.+15', }, })
gear.vijayaBowPathB = hp_gear("Vijaya Bow", 0, {
    augments = { 'DMG:+15', 'AGI+15', 'Rng.Acc.+15', }, })
gear.vijayaBowPathC = hp_gear("Vijaya Bow", 0, {
    augments = { 'DMG:+15', 'Rng.Acc.+15', 'Rng.Atk.+15', }, })
gear.vijayaBowPathD = hp_gear("Vijaya Bow", 0, {
...
gear.alardAxePlusOne = rank_gear("Alard's Axe +1", 100)         --Lv.85
gear.alardAxePlusTwo = rank_gear("Alard's Axe +2", 100)         --Lv.90
gear.alardAxePlusThree = rank_gear("Alard's Axe +3", 100)       --Lv.95
gear.astolfo = rank_gear("Astolfo", 100)                        --Lv.99
gear.aymur = rank_gear("Aymur", 100)                            --Lv.75
gear.bonebiter = rank_gear("Bonebiter", 100)                    --Lv.75
gear.chopper = rank_gear("Chopper", 100)                        --Lv.75
gear.farsha = rank_gear("Farsha", 100)                          --Lv.80
gear.fernagu = rank_gear("Fernagu", 100)                        --Lv.99
gear.ganelon = rank_gear("Ganelon", 100)                        --Lv.99
gear.guichardAxe = rank_gear("Guichard's Axe", 100)             --Lv.80
gear.guichardAxePlusOne = rank_gear("Guichard's Axe +1", 100)   --Lv.85
gear.guichardAxePlusTwo = rank_gear("Guichard's Axe +2", 100)   --Lv.90
gear.guichardAxePlusThree = rank_gear("Guichard's Axe +3", 100) --Lv.95
gear.guttler = rank_gear("Guttler", 100)                        --Lv.75
gear.punisher = rank_gear("Punisher", 100)                      --Lv.75
gear.renaudAxe = rank_gear("Renaud's Axe", 100)                 --Lv.80
gear.renaudAxePlusOne = rank_gear("Renaud's Axe +1", 100)       --Lv.85
gear.renaudAxePlusTwo = rank_gear("Renaud's Axe +2", 100)       --Lv.90
gear.renaudAxePlusThree = rank_gear("Renaud's Axe +3", 100)     --Lv.95
gear.richardetAxePlusTwo = rank_gear("Richard. Axe +2", 100)    --Lv.90
gear.richardetAxe = rank_gear("Richardet's Axe", 100)           --Lv.80
gear.richardetAxePlusOne = rank_gear("Richardet's Axe +1", 100) --Lv.85
gear.sacripante = rank_gear("Sacripante", 100)                  --Lv.99
gear.skeggiold = rank_gear("Skeggiold", 100)                    --Lv.75
gear.splinter = rank_gear("Splinter", 100)                      --Lv.75

--Trial of the Magians: Clubs
gear.canneDeCombatPlusOne = rank_gear("Canne de Cbt. +1", 100)   --Lv.85
gear.canneDeCombatPlusTwo = rank_gear("Canne de Cbt. +2", 100)   --Lv.90
gear.canneDeCombatPlusThree = rank_gear("Canne de Cbt. +3", 100) --Lv.95
gear.canneDeCombat = rank_gear("Canne de Combat", 100)           --Lv.80
gear.culacula = rank_gear("Culacula", 100)                       --Lv.75
gear.gambanteinn = rank_gear("Gambanteinn", 100)                 --Lv.80
gear.goedendag = rank_gear("Goedendag", 100)                     --Lv.75
gear.hoeroa = rank_gear("Hoeroa", 100)                           --Lv.80
gear.hoeroaPlusOne = rank_gear("Hoeroa +1", 100)                 --Lv.85
gear.hoeroaPlusTwo = rank_gear("Hoeroa +2", 100)                 --Lv.90
gear.hoeroaPlusThree = rank_gear("Hoeroa +3", 100)               --Lv.95
gear.ingrimm = rank_gear("Ingrimm", 100)                         --Lv.75
gear.makhila = rank_gear("Makhila", 100)                         --Lv.80
gear.makhilaPlusOne = rank_gear("Makhila +1", 100)               --Lv.85
gear.makhilaPlusTwo = rank_gear("Makhila +2", 100)               --Lv.90
gear.makhilaPlusThree = rank_gear("Makhila +3", 100)             --Lv.95
gear.mjollnir = rank_gear("Mjollnir", 100)                       --Lv.75
gear.naboot = rank_gear("Naboot", 100)                           --Lv.80
gear.nabootPlusOne = rank_gear("Naboot +1", 100)                 --Lv.85
gear.nabootPlusTwo = rank_gear("Naboot +2", 100)                 --Lv.90
gear.nabootPlusThree = rank_gear("Naboot +3", 100)               --Lv.95
gear.rageblow = rank_gear("Rageblow", 100)                       --Lv.75
gear.roseCouverte = rank_gear("Rose Couverte", 100)              --Lv.99
gear.stenz = rank_gear("Stenz", 100)                             --Lv.75
gear.tahtib = rank_gear("Tahtib", 100)                           --Lv.99
gear.tutunui = rank_gear("Tutunui", 100)                         --Lv.99
gear.ukaldi = rank_gear("Ukaldi", 100)                           --Lv.99

--Trial of the Magians: Daggers
gear.athame = rank_gear("Athame", 100)                     --Lv.75
gear.centovente = rank_gear("Centovente", 100)             --Lv.99
gear.daka = rank_gear("Daka", 100)                         --Lv.80
gear.dakaPlusOne = rank_gear("Daka +1", 100)               --Lv.85
gear.dakaPlusTwo = rank_gear("Daka +2", 100)               --Lv.90
gear.dakaPlusThree = rank_gear("Daka +3", 100)             --Lv.95
gear.dakini = rank_gear("Dakini", 100)                     --Lv.75
gear.fusetto = rank_gear("Fusetto", 100)                   --Lv.80
gear.fusettoPlusOne = rank_gear("Fusetto +1", 100)         --Lv.85
gear.fusettoPlusTwo = rank_gear("Fusetto +2", 100)         --Lv.90
gear.fusettoPlusThree = rank_gear("Fusetto +3", 100)       --Lv.95
gear.kartika = rank_gear("Kartika", 100)                   --Lv.75
gear.khandroma = rank_gear("Khandroma", 100)               --Lv.99
gear.kila = rank_gear("Kila", 100)                         --Lv.80
gear.kilaPlusOne = rank_gear("Kila +1", 100)               --Lv.85
gear.kilaPlusTwo = rank_gear("Kila +2", 100)               --Lv.90
gear.kilaPlusThree = rank_gear("Kila +3", 100)             --Lv.95
gear.mandau = rank_gear("Mandau", 100)                     --Lv.75
gear.parazonium = rank_gear("Parazonium", 100)             --Lv.80
gear.parazoniumPlusOne = rank_gear("Parazonium +1", 100)   --Lv.85
gear.parazoniumPlusTwo = rank_gear("Parazonium +2", 100)   --Lv.90
gear.parazoniumPlusThree = rank_gear("Parazonium +3", 100) --Lv.95
gear.peeler = rank_gear("Peeler", 100)                     --Lv.75
gear.praxidikai = rank_gear("Praxidikai", 100)             --Lv.99
gear.renegade = rank_gear("Renegade", 100)                 --Lv.75
gear.terpsichore = rank_gear("Terpsichore", 100)           --Lv.75
gear.thokcha = rank_gear("Thokcha", 100)                   --Lv.99
gear.twashtar = rank_gear("Twashtar", 100)                 --Lv.80
gear.vajra = rank_gear("Vajra", 100)                       --Lv.75

--Trial of the Magians: Great Axes
gear.atlas = rank_gear("Atlas", 100)               --Lv.80
gear.atlasPlusOne = rank_gear("Atlas +1", 100)     --Lv.85
gear.atlasPlusTwo = rank_gear("Atlas +2", 100)     --Lv.90
gear.atlasPlusThree = rank_gear("Atlas +3", 100)   --Lv.95
gear.bonesplitter = rank_gear("Bonesplitter", 100) --Lv.75
gear.bravura = rank_gear("Bravura", 100)           --Lv.75
gear.conqueror = rank_gear("Conqueror", 100)       --Lv.75
gear.hephaestus = rank_gear("Hephaestus", 100)     --Lv.75
gear.kunlun = rank_gear("Kunlun", 100)             --Lv.80
gear.kunlunPlusOne = rank_gear("Kunlun +1", 100)   --Lv.85
gear.kunlunPlusTwo = rank_gear("Kunlun +2", 100)   --Lv.90
gear.kunlunPlusThree = rank_gear("Kunlun +3", 100) --Lv.95
gear.liushiShan = rank_gear("Liushi Shan", 100)    --Lv.99
gear.luchtaine = rank_gear("Luchtaine", 100)       --Lv.75
gear.lumberjack = rank_gear("Lumberjack", 100)     --Lv.75
gear.maschu = rank_gear("Maschu", 100)             --Lv.80
gear.maschuPlusOne = rank_gear("Maschu +1", 100)   --Lv.85
gear.maschuPlusTwo = rank_gear("Maschu +2", 100)   --Lv.90
gear.maschuPlusThree = rank_gear("Maschu +3", 100) --Lv.95
gear.sagaris = rank_gear("Sagaris", 100)           --Lv.75
gear.shamash = rank_gear("Shamash", 100)           --Lv.99
gear.sumeru = rank_gear("Sumeru", 100)             --Lv.80
gear.sumeruPlusOne = rank_gear("Sumeru +1", 100)   --Lv.85
gear.sumeruPlusTwo = rank_gear("Sumeru +2", 100)   --Lv.90
gear.sumeruPlusThree = rank_gear("Sumeru +3", 100) --Lv.95
gear.tavatimsa = rank_gear("Tavatimsa", 100)       --Lv.99
gear.telamon = rank_gear("Telamon", 100)           --Lv.99
gear.ukonvasara = rank_gear("Ukonvasara", 100)     --Lv.80

--Trial of the Magians: Great Katanas
gear.amanomurakumo = rank_gear("Amanomurakumo", 100)                --Lv.75
gear.donto = rank_gear("Donto", 100)                                --Lv.75
gear.efunotachi = rank_gear("Efunotachi", 100)                      --Lv.75
gear.hiradennotachi = rank_gear("Hiradennotachi", 100)              --Lv.80
gear.hiradennotachiPlusOne = rank_gear("Hiradennotachi +1", 100)    --Lv.85
gear.hiradennotachiPlusTwo = rank_gear("Hiradennotachi +2", 100)    --Lv.90
gear.hiradennotachiPlusThree = rank_gear("Hiradennotachi +3", 100)  --Lv.95
gear.hyogugusarinotachiPlusOne = rank_gear("Hyogugusari +1", 100)   --Lv.85
gear.hyogugusarinotachiPlusTwo = rank_gear("Hyogugusari +2", 100)   --Lv.90
gear.hyogugusarinotachiPlusThree = rank_gear("Hyogugusari +3", 100) --Lv.95
gear.hyogugusarinotachi = rank_gear("Hyogugusarinotachi", 100)      --Lv.80
gear.kabutsuchinotachi = rank_gear("Kabutsuchi", 100)               --Lv.99
gear.kantonotachi = rank_gear("Kantonotachi", 100)                  --Lv.99
gear.kawatsutsuminotachi = rank_gear("Kawatsutsumi", 100)           --Lv.99
gear.keitonotachi = rank_gear("Keitonotachi", 100)                  --Lv.80
gear.keitonotachiPlusOne = rank_gear("Keitonotachi +1", 100)        --Lv.85
gear.keitonotachiPlusTwo = rank_gear("Keitonotachi +2", 100)        --Lv.90
gear.keitonotachiPlusThree = rank_gear("Keitonotachi +3", 100)      --Lv.95
gear.kogarasumaru = rank_gear("Kogarasumaru", 100)                  --Lv.75
gear.kokushitsunotachiPlusOne = rank_gear("Kokushitsu +1", 100)     --Lv.85
gear.kokushitsunotachiPlusTwo = rank_gear("Kokushitsu +2", 100)     --Lv.90
gear.kokushitsunotachiPlusThree = rank_gear("Kokushitsu +3", 100)   --Lv.95
gear.kokushitsunotachi = rank_gear("Kokushitsunotachi", 100)        --Lv.80
gear.kurodachi = rank_gear("Kurodachi", 100)                        --Lv.75
gear.radennotachi = rank_gear("Radennotachi", 100)                  --Lv.75
gear.shirodachi = rank_gear("Shirodachi", 100)                      --Lv.75
gear.torigashiranotachi = rank_gear("Torigashira", 100)             --Lv.99

--Trial of the Magians: Great Swords
gear.albion = rank_gear("Albion", 100)                     --Lv.75
gear.brandDarcon = rank_gear("Brand d'Arcon", 100)         --Lv.75
gear.breakBlade = rank_gear("Break Blade", 100)            --Lv.75
gear.caladbolg = rank_gear("Caladbolg", 100)               --Lv.80
gear.espafut = rank_gear("Espafut", 100)                   --Lv.80
gear.espafutPlusOne = rank_gear("Espafut +1", 100)         --Lv.85
gear.espafutPlusTwo = rank_gear("Espafut +2", 100)         --Lv.90
gear.espafutPlusThree = rank_gear("Espafut +3", 100)       --Lv.95
gear.fulgurante = rank_gear("Fulgurante", 100)             --Lv.99
gear.kalavejs = rank_gear("Kalavejs", 100)                 --Lv.80
gear.kalavejsPlusOne = rank_gear("Kalavejs +1", 100)       --Lv.85
gear.kalavejsPlusTwo = rank_gear("Kalavejs +2", 100)       --Lv.90
gear.kalavejsPlusThree = rank_gear("Kalavejs +3", 100)     --Lv.95
gear.kauriraris = rank_gear("Kauriraris", 100)             --Lv.99
gear.prestelame = rank_gear("Prestelame", 100)             --Lv.80
gear.prestelamePlusOne = rank_gear("Prestelame +1", 100)   --Lv.85
gear.prestelamePlusTwo = rank_gear("Prestelame +2", 100)   --Lv.90
gear.prestelamePlusThree = rank_gear("Prestelame +3", 100) --Lv.95
gear.ragnarok = rank_gear("Ragnarok", 100)                 --Lv.75
gear.salamandSword = rank_gear("Salamand Sword", 100)      --Lv.75
gear.sombrelame = rank_gear("Sombrelame", 100)             --Lv.80
gear.sombrelamePlusOne = rank_gear("Sombrelame +1", 100)   --Lv.85
gear.sombrelamePlusTwo = rank_gear("Sombrelame +2", 100)   --Lv.90
gear.sombrelamePlusThree = rank_gear("Sombrelame +3", 100) --Lv.95
gear.sunblade = rank_gear("Sunblade", 100)                 --Lv.75
gear.tenebreuse = rank_gear("Tenebreuse", 100)             --Lv.99
gear.xiphias = rank_gear("Xiphias", 100)                   --Lv.99

--Trial of the Magians: Hand-to-Hand
gear.barracudas = rank_gear("Barracudas", 100)                    --Lv.80
gear.barracudasPlusOne = rank_gear("Barracudas +1", 100)          --Lv.85
gear.barracudasPlusTwo = rank_gear("Barracudas +2", 100)          --Lv.90
gear.barracudasPlusThree = rank_gear("Barracudas +3", 100)        --Lv.95
gear.catClaws = rank_gear("Cat's Claws", 100)                     --Lv.75
gear.dumuzis = rank_gear("Dumuzis", 100)                          --Lv.99
gear.glanzfaust = rank_gear("Glanzfaust", 100)                    --Lv.75
gear.kenkonken = rank_gear("Kenkonken", 100)                      --Lv.75
gear.mantis = rank_gear("Mantis", 100)                            --Lv.75
gear.oxyuranis = rank_gear("Oxyuranis", 100)                      --Lv.99
gear.pugilists = rank_gear("Pugilists", 100)                      --Lv.75
gear.revenantFists = rank_gear("Revenant Fists", 100)             --Lv.80
gear.revenantFistsPlusOne = rank_gear("Revenant Fists +1", 100)   --Lv.85
gear.revenantFistsPlusTwo = rank_gear("Revenant Fists +2", 100)   --Lv.90
gear.revenantFistsPlusThree = rank_gear("Revenant Fists +3", 100) --Lv.95
gear.simianFists = rank_gear("Simian Fists", 100)                 --Lv.75
gear.spharai = rank_gear("Spharai", 100)                          --Lv.75
gear.sphyras = rank_gear("Sphyras", 100)                          --Lv.99
gear.taipanFangs = rank_gear("Taipan Fangs", 100)                 --Lv.80
gear.taipanFangsPlusOne = rank_gear("Taipan Fangs +1", 100)       --Lv.85
gear.taipanFangsPlusTwo = rank_gear("Taipan Fangs +2", 100)       --Lv.90
gear.taipanFangsPlusThree = rank_gear("Taipan Fangs +3", 100)     --Lv.95
gear.ursaMajors = rank_gear("Ursa Majors", 100)                   --Lv.99
gear.ursineClaws = rank_gear("Ursine Claws", 100)                 --Lv.80
gear.ursineClawsPlusOne = rank_gear("Ursine Claws +1", 100)       --Lv.85
gear.ursineClawsPlusTwo = rank_gear("Ursine Claws +2", 100)       --Lv.90
gear.ursineClawsPlusThree = rank_gear("Ursine Claws +3", 100)     --Lv.95
gear.wargfangs = rank_gear("Wargfangs", 100)                      --Lv.75

--Trial of the Magians: Katanas
gear.arisui = rank_gear("Arisui", 100)           --Lv.99
gear.enchu = rank_gear("Enchu", 100)             --Lv.80
gear.enchuPlusOne = rank_gear("Enchu +1", 100)   --Lv.85
gear.enchuPlusTwo = rank_gear("Enchu +2", 100)   --Lv.90
gear.enchuPlusThree = rank_gear("Enchu +3", 100) --Lv.95
gear.hitaki = rank_gear("Hitaki", 100)           --Lv.99
gear.isatu = rank_gear("Isatu", 100)             --Lv.75
gear.kasasagi = rank_gear("Kasasagi", 100)       --Lv.99
gear.kibashiri = rank_gear("Kibashiri", 100)     --Lv.75
gear.kikoku = rank_gear("Kikoku", 100)           --Lv.75
gear.koruri = rank_gear("Koruri", 100)           --Lv.75
gear.kuina = rank_gear("Kuina", 100)             --Lv.75
gear.majimun = rank_gear("Majimun", 100)         --Lv.99
gear.mozu = rank_gear("Mozu", 100)               --Lv.75
gear.nagi = rank_gear("Nagi", 100)               --Lv.75
gear.sekka = rank_gear("Sekka", 100)             --Lv.80
gear.sekkaPlusOne = rank_gear("Sekka +1", 100)   --Lv.85
gear.sekkaPlusTwo = rank_gear("Sekka +2", 100)   --Lv.90
gear.sekkaPlusThree = rank_gear("Sekka +3", 100) --Lv.95
gear.tobi = rank_gear("Tobi", 100)               --Lv.80
gear.tobiPlusOne = rank_gear("Tobi +1", 100)     --Lv.85
gear.tobiPlusTwo = rank_gear("Tobi +2", 100)     --Lv.90
gear.tobiPlusThree = rank_gear("Tobi +3", 100)   --Lv.95
gear.uzura = rank_gear("Uzura", 100)             --Lv.80
gear.uzuraPlusOne = rank_gear("Uzura +1", 100)   --Lv.85
gear.uzuraPlusTwo = rank_gear("Uzura +2", 100)   --Lv.90
gear.uzuraPlusThree = rank_gear("Uzura +3", 100) --Lv.95

--Trial of the Magians: Polearms
gear.bradamante = rank_gear("Bradamante", 100)             --Lv.75
gear.cerastes = rank_gear("Cerastes", 100)                 --Lv.80
gear.cerastesPlusOne = rank_gear("Cerastes +1", 100)       --Lv.85
gear.cerastesPlusTwo = rank_gear("Cerastes +2", 100)       --Lv.90
gear.cerastesPlusThree = rank_gear("Cerastes +3", 100)     --Lv.95
gear.chauveSouris = rank_gear("Chauve-Souris", 100)        --Lv.99
gear.copperhead = rank_gear("Copperhead", 100)             --Lv.75
gear.corsesca = rank_gear("Corsesca", 100)                 --Lv.80
gear.corsescaPlusOne = rank_gear("Corsesca +1", 100)       --Lv.85
gear.corsescaPlusTwo = rank_gear("Corsesca +2", 100)       --Lv.90
gear.corsescaPlusThree = rank_gear("Corsesca +3", 100)     --Lv.95
gear.daboya = rank_gear("Daboya", 100)                     --Lv.99
gear.gungnir = rank_gear("Gungnir", 100)                   --Lv.75
gear.langdebeve = rank_gear("Langdebeve", 100)             --Lv.80
gear.langdebevePlusOne = rank_gear("Langdebeve +1", 100)   --Lv.85
gear.langdebevePlusTwo = rank_gear("Langdebeve +2", 100)   --Lv.90
gear.langdebevePlusThree = rank_gear("Langdebeve +3", 100) --Lv.95
gear.nahvalr = rank_gear("Nahvalr", 100)                   --Lv.99
gear.oathkeeper = rank_gear("Oathkeeper", 100)             --Lv.75
gear.ranseur = rank_gear("Ranseur", 100)                   --Lv.75
gear.rhongomiant = rank_gear("Rhongomiant", 100)           --Lv.80
gear.ryunohige = rank_gear("Ryunohige", 100)               --Lv.75
gear.sixgill = rank_gear("Sixgill", 100)                   --Lv.99
gear.stingray = rank_gear("Stingray", 100)                 --Lv.80
gear.stingrayPlusOne = rank_gear("Stingray +1", 100)       --Lv.85
gear.stingrayPlusTwo = rank_gear("Stingray +2", 100)       --Lv.90
gear.stingrayPlusThree = rank_gear("Stingray +3", 100)     --Lv.95
gear.stribog = rank_gear("Stribog", 100)                   --Lv.75

--Trial of the Magians: Scythes
gear.absolution = rank_gear("Absolution", 100)               --Lv.80
gear.absolutionPlusOne = rank_gear("Absolution +1", 100)     --Lv.85
gear.absolutionPlusTwo = rank_gear("Absolution +2", 100)     --Lv.90
gear.absolutionPlusThree = rank_gear("Absolution +3", 100)   --Lv.95
gear.apocalypse = rank_gear("Apocalypse", 100)               --Lv.75
gear.basanizo = rank_gear("Basanizo", 100)                   --Lv.99
gear.cloacina = rank_gear("Cloacina", 100)                   --Lv.99
gear.farmhand = rank_gear("Farmhand", 100)                   --Lv.75
gear.liberator = rank_gear("Liberator", 100)                 --Lv.75
gear.maleficence = rank_gear("Maleficence", 100)             --Lv.80
gear.maleficencePlusOne = rank_gear("Maleficence +1", 100)   --Lv.85
gear.maleficencePlusTwo = rank_gear("Maleficence +2", 100)   --Lv.90
gear.maleficencePlusThree = rank_gear("Maleficence +3", 100) --Lv.95
gear.ogresse = rank_gear("Ogresse", 100)                     --Lv.99
gear.penitence = rank_gear("Penitence", 100)                 --Lv.80
gear.penitencePlusOne = rank_gear("Penitence +1", 100)       --Lv.85
gear.penitencePlusTwo = rank_gear("Penitence +2", 100)       --Lv.90
gear.penitencePlusThree = rank_gear("Penitence +3", 100)     --Lv.95
gear.reckoning = rank_gear("Reckoning", 100)                 --Lv.80
gear.reckoningPlusOne = rank_gear("Reckoning +1", 100)       --Lv.85
gear.reckoningPlusTwo = rank_gear("Reckoning +2", 100)       --Lv.90
gear.reckoningPlusThree = rank_gear("Reckoning +3", 100)     --Lv.95
gear.redemption = rank_gear("Redemption", 100)               --Lv.80
gear.severance = rank_gear("Severance", 100)                 --Lv.75
gear.stigma = rank_gear("Stigma", 100)                       --Lv.75
gear.ultimatum = rank_gear("Ultimatum", 100)                 --Lv.75
gear.umiliati = rank_gear("Umiliati", 100)                   --Lv.99
gear.vengeance = rank_gear("Vengeance", 100)                 --Lv.75

--Trial of the Magians: Staves
gear.agniStaff = rank_gear("Agni's Staff", 100)                 --Lv.80
gear.agniStaffPlusOne = rank_gear("Agni's Staff +1", 100)       --Lv.85
gear.agniStaffPlusTwo = rank_gear("Agni's Staff +2", 100)       --Lv.90
gear.agniStaffPlusThree = rank_gear("Agni's Staff +3", 100)     --Lv.95
gear.apamajasI = rank_gear("Apamajas I", 100)                   --Lv.99
gear.apamajasIi = rank_gear("Apamajas II", 100)                 --Lv.99
gear.apamajasIii = rank_gear("Apamajas III", 100)               --Lv.99
gear.arkaI = rank_gear("Arka I", 100)                           --Lv.99
gear.arkaIi = rank_gear("Arka II", 100)                         --Lv.99
gear.arkaIii = rank_gear("Arka III", 100)                       --Lv.99
gear.arkaIv = rank_gear("Arka IV", 100)                         --Lv.99
gear.atarI = rank_gear("Atar I", 100)                           --Lv.99
gear.atarIi = rank_gear("Atar II", 100)                         --Lv.99
gear.atarIii = rank_gear("Atar III", 100)                       --Lv.99
gear.claustrum = rank_gear("Claustrum", 100)                    --Lv.75
gear.crook = rank_gear("Crook", 100)                            --Lv.75
gear.danda = rank_gear("Danda", 100)                            --Lv.75
gear.haomaI = rank_gear("Haoma I", 100)                         --Lv.99
gear.haomaIi = rank_gear("Haoma II", 100)                       --Lv.99
gear.haomaIii = rank_gear("Haoma III", 100)                     --Lv.99
gear.hvergelmir = rank_gear("Hvergelmir", 100)                  --Lv.80
gear.indraStaff = rank_gear("Indra's Staff", 100)               --Lv.80
gear.indraStaffPlusOne = rank_gear("Indra's Staff +1", 100)     --Lv.85
gear.indraStaffPlusTwo = rank_gear("Indra's Staff +2", 100)     --Lv.90
gear.indraStaffPlusThree = rank_gear("Indra's Staff +3", 100)   --Lv.95
gear.kuberaStaff = rank_gear("Kubera's Staff", 100)             --Lv.80
gear.kuberaStaffPlusOne = rank_gear("Kubera's Staff +1", 100)   --Lv.85
gear.kuberaStaffPlusTwo = rank_gear("Kubera's Staff +2", 100)   --Lv.90
gear.kuberaStaffPlusThree = rank_gear("Kubera's Staff +3", 100) --Lv.95
gear.laevateinn = rank_gear("Laevateinn", 100)                  --Lv.75
gear.muruga = rank_gear("Muruga", 100)                          --Lv.99
gear.paikea = rank_gear("Paikea", 100)                          --Lv.99
gear.sedikutchi = rank_gear("Sedikutchi", 100)                  --Lv.80
gear.sedikutchiPlusOne = rank_gear("Sedikutchi +1", 100)        --Lv.85
gear.sedikutchiPlusTwo = rank_gear("Sedikutchi +2", 100)        --Lv.90
gear.sedikutchiPlusThree = rank_gear("Sedikutchi +3", 100)      --Lv.95
gear.shareeravadi = rank_gear("Shareeravadi", 100)              --Lv.80
gear.shareeravadiPlusOne = rank_gear("Shareeravadi +1", 100)    --Lv.85
gear.shareeravadiPlusTwo = rank_gear("Shareeravadi +2", 100)    --Lv.90
gear.shareeravadiPlusThree = rank_gear("Shareeravadi +3", 100)  --Lv.95
gear.shillelagh = rank_gear("Shillelagh", 100)                  --Lv.75
gear.slaine = rank_gear("Slaine", 100)                          --Lv.75
gear.somaStaff = rank_gear("Soma's Staff", 100)                 --Lv.80
gear.somaStaffPlusOne = rank_gear("Soma's Staff +1", 100)       --Lv.85
gear.somaStaffPlusTwo = rank_gear("Soma's Staff +2", 100)       --Lv.90
gear.somaStaffPlusThree = rank_gear("Soma's Staff +3", 100)     --Lv.95
gear.suryaStaff = rank_gear("Surya's Staff", 100)               --Lv.80
gear.suryaStaffPlusOne = rank_gear("Surya's Staff +1", 100)     --Lv.85
gear.suryaStaffPlusTwo = rank_gear("Surya's Staff +2", 100)     --Lv.90
gear.suryaStaffPlusThree = rank_gear("Surya's Staff +3", 100)   --Lv.95
gear.taiaha = rank_gear("Taiaha", 100)                          --Lv.80
gear.taiahaPlusOne = rank_gear("Taiaha +1", 100)                --Lv.85
gear.taiahaPlusTwo = rank_gear("Taiaha +2", 100)                --Lv.90
gear.taiahaPlusThree = rank_gear("Taiaha +3", 100)              --Lv.95
gear.teiwaz = rank_gear("Teiwaz", 100)                          --Lv.75
gear.tuahjebat = rank_gear("Tuahjebat", 100)                    --Lv.99
gear.tupsimati = rank_gear("Tupsimati", 100)                    --Lv.75
gear.urduja = rank_gear("Urduja", 100)                          --Lv.99
gear.varunaStaff = rank_gear("Varuna's Staff", 100)             --Lv.80
gear.varunaStaffPlusOne = rank_gear("Varuna's Staff +1", 100)   --Lv.85
gear.varunaStaffPlusTwo = rank_gear("Varuna's Staff +2", 100)   --Lv.90
gear.varunaStaffPlusThree = rank_gear("Varuna's Staff +3", 100) --Lv.95
gear.vayuStaff = rank_gear("Vayu's Staff", 100)                 --Lv.80
gear.vayuStaffPlusOne = rank_gear("Vayu's Staff +1", 100)       --Lv.85
gear.vayuStaffPlusTwo = rank_gear("Vayu's Staff +2", 100)       --Lv.90
gear.vayuStaffPlusThree = rank_gear("Vayu's Staff +3", 100)     --Lv.95
gear.vayuvataI = rank_gear("Vayuvata I", 100)                   --Lv.99
gear.vayuvataIi = rank_gear("Vayuvata II", 100)                 --Lv.99
gear.vayuvataIii = rank_gear("Vayuvata III", 100)               --Lv.99
gear.vishravaI = rank_gear("Vishrava I", 100)                   --Lv.99
gear.vishravaIi = rank_gear("Vishrava II", 100)                 --Lv.99
gear.vishravaIii = rank_gear("Vishrava III", 100)               --Lv.99
gear.vourukashaI = rank_gear("Vourukasha I", 100)               --Lv.99
gear.vourukashaIi = rank_gear("Vourukasha II", 100)             --Lv.99
gear.vourukashaIii = rank_gear("Vourukasha III", 100)           --Lv.99
gear.xsaetaI = rank_gear("Xsaeta I", 100)                       --Lv.99
gear.xsaetaIi = rank_gear("Xsaeta II", 100)                     --Lv.99
gear.xsaetaIii = rank_gear("Xsaeta III", 100)                   --Lv.99
gear.yamaStaff = rank_gear("Yama's Staff", 100)                 --Lv.80
gear.yamaStaffPlusOne = rank_gear("Yama's Staff +1", 100)       --Lv.85
gear.yamaStaffPlusTwo = rank_gear("Yama's Staff +2", 100)       --Lv.90
gear.yamaStaffPlusThree = rank_gear("Yama's Staff +3", 100)     --Lv.95
gear.yantok = rank_gear("Yantok", 100)                          --Lv.80
gear.yantokPlusOne = rank_gear("Yantok +1", 100)                --Lv.85
gear.yantokPlusTwo = rank_gear("Yantok +2", 100)                --Lv.90
gear.yantokPlusThree = rank_gear("Yantok +3", 100)              --Lv.95

--Trial of the Magians: Swords
gear.antea = rank_gear("Antea", 100)                     --Lv.75
gear.badelaire = rank_gear("Badelaire", 100)             --Lv.80
gear.badelairePlusOne = rank_gear("Badelaire +1", 100)   --Lv.85
gear.badelairePlusTwo = rank_gear("Badelaire +2", 100)   --Lv.90
gear.badelairePlusThree = rank_gear("Badelaire +3", 100) --Lv.95
gear.brunello = rank_gear("Brunello", 100)               --Lv.99
gear.excalibur = rank_gear("Excalibur", 100)             --Lv.75
gear.khadga = rank_gear("Khadga", 100)                   --Lv.99
gear.khanda = rank_gear("Khanda", 100)                   --Lv.80
gear.khandaPlusOne = rank_gear("Khanda +1", 100)         --Lv.85
gear.khandaPlusTwo = rank_gear("Khanda +2", 100)         --Lv.90
gear.khandaPlusThree = rank_gear("Khanda +3", 100)       --Lv.95
gear.machaera = rank_gear("Machaera", 100)               --Lv.80
gear.machaeraPlusOne = rank_gear("Machaera +1", 100)     --Lv.85
gear.machaeraPlusTwo = rank_gear("Machaera +2", 100)     --Lv.90
gear.machaeraPlusThree = rank_gear("Machaera +3", 100)   --Lv.95
gear.murgleis = rank_gear("Murgleis", 100)               --Lv.75
gear.nobilis = rank_gear("Nobilis", 100)                 --Lv.75
gear.schiavona = rank_gear("Schiavona", 100)             --Lv.75
gear.shamshir = rank_gear("Shamshir", 100)               --Lv.80
gear.shamshirPlusOne = rank_gear("Shamshir +1", 100)     --Lv.85
gear.shamshirPlusTwo = rank_gear("Shamshir +2", 100)     --Lv.90
gear.shamshirPlusThree = rank_gear("Shamshir +3", 100)   --Lv.95
gear.shikargar = rank_gear("Shikargar", 100)             --Lv.99
gear.sideSword = rank_gear("Side-sword", 100)            --Lv.75
gear.soulsaber = rank_gear("Soulsaber", 100)             --Lv.75
gear.thibron = rank_gear("Thibron", 100)                 --Lv.99
gear.tizona = rank_gear("Tizona", 100)                   --Lv.75

--Trial of the Magians: Archery
gear.accipiter = hp_gear("Accipiter", 0)                 --Lv.99
gear.astrild = hp_gear("Astrild", 0)                     --Lv.75
gear.bateleur = hp_gear("Bateleur", 0)                   --Lv.80
gear.bateleurPlusOne = hp_gear("Bateleur +1", 0)         --Lv.85
gear.bateleurPlusTwo = hp_gear("Bateleur +2", 0)         --Lv.90
gear.bateleurPlusThree = hp_gear("Bateleur +3", 0)       --Lv.95
gear.circinae = hp_gear("Circinae", 0)                   --Lv.99
gear.condor = hp_gear("Condor", 0)                       --Lv.80
gear.condorPlusOne = hp_gear("Condor +1", 0)             --Lv.85
gear.condorPlusTwo = hp_gear("Condor +2", 0)             --Lv.90
gear.condorPlusThree = hp_gear("Condor +3", 0)           --Lv.95
gear.gandiva = hp_gear("Gandiva", 0)                     --Lv.80
gear.goshawk = hp_gear("Goshawk", 0)                     --Lv.75
gear.gymnogyps = hp_gear("Gymnogyps", 0)                 --Lv.99
gear.gyrfalcon = hp_gear("Gyrfalcon", 0)                 --Lv.75
gear.harrier = hp_gear("Harrier", 0)                     --Lv.80
gear.harrierPlusOne = hp_gear("Harrier +1", 0)           --Lv.85
gear.harrierPlusTwo = hp_gear("Harrier +2", 0)           --Lv.90
gear.harrierPlusThree = hp_gear("Harrier +3", 0)         --Lv.95
gear.kestrel = hp_gear("Kestrel", 0)                     --Lv.75
gear.sparrow = hp_gear("Sparrow", 0)                     --Lv.75
gear.sparrowhawk = hp_gear("Sparrowhawk", 0)             --Lv.80
gear.sparrowhawkPlusOne = hp_gear("Sparrowhawk +1", 0)   --Lv.85
gear.sparrowhawkPlusTwo = hp_gear("Sparrowhawk +2", 0)   --Lv.90
gear.sparrowhawkPlusThree = hp_gear("Sparrowhawk +3", 0) --Lv.95
gear.terathopus = hp_gear("Terathopus", 0)               --Lv.99

--Trial of the Magians: Marksmanship (guns and crossbows)
gear.aithon = hp_gear("Aithon", 0)                 --Lv.99
gear.anarchy = hp_gear("Anarchy", 0)               --Lv.80
gear.anarchyPlusOne = hp_gear("Anarchy +1", 0)     --Lv.85
gear.anarchyPlusTwo = hp_gear("Anarchy +2", 0)     --Lv.90
gear.anarchyPlusThree = hp_gear("Anarchy +3", 0)   --Lv.95
gear.armageddon = hp_gear("Armageddon", 0)         --Lv.80
gear.ataktos = hp_gear("Ataktos", 0)               --Lv.99
gear.bedlam = hp_gear("Bedlam", 0)                 --Lv.80
gear.bedlamPlusOne = hp_gear("Bedlam +1", 0)       --Lv.85
gear.bedlamPlusTwo = hp_gear("Bedlam +2", 0)       --Lv.90
gear.bedlamPlusThree = hp_gear("Bedlam +3", 0)     --Lv.95
gear.blueSteel = hp_gear("Blue Steel", 0)          --Lv.75
gear.dragonmaw = hp_gear("Dragonmaw", 0)           --Lv.75
gear.erraGun = hp_gear("Erra", 0)                  --Lv.99
gear.huracan = hp_gear("Huracan", 0)               --Lv.75
gear.magnatus = hp_gear("Magnatus", 0)             --Lv.75
gear.mayhem = hp_gear("Mayhem", 0)                 --Lv.80
gear.mayhemPlusOne = hp_gear("Mayhem +1", 0)       --Lv.85
gear.mayhemPlusTwo = hp_gear("Mayhem +2", 0)       --Lv.90
gear.mayhemPlusThree = hp_gear("Mayhem +3", 0)     --Lv.95
gear.mollfrith = hp_gear("Mollfrith", 0)           --Lv.99
gear.spitfire = hp_gear("Spitfire", 0)             --Lv.80
gear.spitfirePlusOne = hp_gear("Spitfire +1", 0)   --Lv.85
gear.spitfirePlusTwo = hp_gear("Spitfire +2", 0)   --Lv.90
gear.spitfirePlusThree = hp_gear("Spitfire +3", 0) --Lv.95
gear.thunderstick = hp_gear("Thunderstick", 0)     --Lv.75

--Trial of the Magians: Instruments
gear.pyfHarp = hp_gear("Pyf Harp", 0) --Lv.85

--Trial of the Magians: Shields
gear.utilisShield = hp_gear("Utilis Shield", 0) --Lv.85
